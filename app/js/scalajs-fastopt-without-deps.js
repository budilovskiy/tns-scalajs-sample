...
var $d_Lshared_entities_FacadeTypes$JsContactInfo = new $TypeData().initClass({
  Lshared_entities_FacadeTypes$JsContactInfo: 0
}, false, "shared.entities.FacadeTypes$JsContactInfo", {
  Lshared_entities_FacadeTypes$JsContactInfo: 1
}, true, (void 0), $noIsInstance);
var $d_Lshared_entities_FacadeTypes$JsDialogInfo = new $TypeData().initClass({
  Lshared_entities_FacadeTypes$JsDialogInfo: 0
}, false, "shared.entities.FacadeTypes$JsDialogInfo", {
  Lshared_entities_FacadeTypes$JsDialogInfo: 1
}, true, (void 0), $noIsInstance);
function $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V($$this, event) {
...
function $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V($$this, f) {
  var this$2 = $$this.listeners$1;
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  $$this.listeners$1 = $as_sci_List($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$2, f, bf))
}
function $s_Lutils_mediator_strategies_ReconnectStrategy$class__apply__Lutils_mediator_strategies_ReconnectStrategy__sci_Queue__F1__sci_Queue($$this, transports, block) {
  var x1 = $$this.process__sci_Queue__T2(transports);
  if ((x1 === null)) {
    throw new $c_s_MatchError().init___O(x1)
  };
  var f = $as_s_Option(x1.$$und1$f);
  var ts = $as_sci_Queue(x1.$$und2$f);
  if ((!f.isEmpty__Z())) {
    block.apply__O__O(f.get__O())
  };
  return ts
}
function $s_Lutils_mediator_transport_SocketIOTransport$class__internalConnect__Lutils_mediator_transport_SocketIOTransport__Lutils_mediator_transport_SocketIOConfig__V($$this, config) {
  $$this.utils$mediator$transport$SocketIOTransport$$socket$1 = new $c_s_Some().init___O(config.socket$1);
  var this$1 = $$this.utils$mediator$transport$SocketIOTransport$$socket$1;
  var f = new $c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1().init___Lutils_mediator_transport_SocketIOTransport($$this);
  if ((!this$1.isEmpty__Z())) {
    var v1 = this$1.get__O();
    f.apply__Lshared_entities_FacadeTypes$SocketIO__V(v1)
  }
}
function $s_Lutils_mediator_transport_SocketIOTransport$class__internalSend__Lutils_mediator_transport_SocketIOTransport__T__V($$this, data) {
  var this$1 = $$this.utils$mediator$transport$SocketIOTransport$$socket$1;
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    arg1.emit("send message", data)
  }
}
function $s_Lutils_mediator_transport_SocketIOTransport$class__$$init$__Lutils_mediator_transport_SocketIOTransport__V($$this) {
  $$this.utils$mediator$transport$SocketIOTransport$$socket$1 = $m_s_None$();
  $$this.timeout$1 = 10000;
  $$this.tryReconnect$1 = false;
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(e$2) {
    $as_T(e$2)
  }));
  var this$1 = $$this.utils$mediator$transport$Transport$$connectEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$1, f);
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(e$2$1) {
    $as_T(e$2$1)
  }));
  var this$2 = $$this.utils$mediator$transport$Transport$$disconnectEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$2, f$1);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(e$2$2) {
    $as_T(e$2$2)
  }));
  var this$3 = $$this.utils$mediator$transport$Transport$$errorEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$3, f$2);
  var f$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(m$2) {
    $as_T(m$2)
  }));
  var this$4 = $$this.utils$mediator$transport$Transport$$receiveMessageEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$4, f$3);
  var f$4 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(m$2$1) {
    $as_T(m$2$1)
  }));
  var this$5 = $$this.utils$mediator$transport$Transport$$sendStringMessageListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$5, f$4);
  var f$5 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(m$2$2) {
    $as_T(m$2$2)
  }));
  var this$6 = $$this.utils$mediator$transport$Transport$$sendRawMessageListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$6, f$5)
}
function $s_Lutils_mediator_transport_Transport$class__connect__Lutils_mediator_transport_Transport__V($$this) {
  var this$1 = $$this.utils$mediator$transport$Transport$$currentConfig$1;
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    var config = $as_Lutils_mediator_transport_SocketIOConfig(arg1);
    $s_Lutils_mediator_transport_SocketIOTransport$class__internalConnect__Lutils_mediator_transport_SocketIOTransport__Lutils_mediator_transport_SocketIOConfig__V($$this, config)
  }
}
function $s_Lutils_mediator_transport_Transport$class__setConfig__Lutils_mediator_transport_Transport__O__V($$this, config) {
  $$this.utils$mediator$transport$Transport$$currentConfig$1 = new $c_s_Some().init___O(config)
}
function $s_Lutils_mediator_transport_Transport$class__internalOnConnect__Lutils_mediator_transport_Transport__O__V($$this, event) {
  $$this.utils$mediator$transport$Transport$$internalConnected$1 = true;
  var this$1 = $$this.utils$mediator$transport$Transport$$connectEventListeners$1;
  $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$1, event)
}
function $s_Lutils_mediator_transport_Transport$class__reconnect__Lutils_mediator_transport_Transport__V($$this) {
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle($$this.timeout$1, new $c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1().init___Lutils_mediator_transport_Transport($$this))
}
function $s_Lutils_mediator_transport_Transport$class__internalOnDisconnect__Lutils_mediator_transport_Transport__O__V($$this, event) {
  $$this.utils$mediator$transport$Transport$$internalConnected$1 = false;
  var this$1 = $$this.utils$mediator$transport$Transport$$disconnectEventListeners$1;
  $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$1, event);
  if ($$this.tryReconnect$1) {
    $s_Lutils_mediator_transport_Transport$class__reconnect__Lutils_mediator_transport_Transport__V($$this)
  }
}
function $s_Lutils_mediator_transport_Transport$class__$$init$__Lutils_mediator_transport_Transport__V($$this) {
  $$this.utils$mediator$transport$Transport$$connectEventListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$disconnectEventListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$errorEventListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$receiveMessageEventListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$sendRawMessageListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$sendStringMessageListeners$1 = new $c_Lutils_mediator_Listener$$anon$1().init___();
  $$this.utils$mediator$transport$Transport$$internalConnected$1 = false;
  $$this.utils$mediator$transport$Transport$$currentConfig$1 = $m_s_None$();
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(x$2) {
      var this$7 = arg$outer.utils$mediator$transport$Transport$$sendStringMessageListeners$1;
      var message = $as_T(x$2);
      $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$7, message)
    })
  })($$this));
  var this$8 = $$this.utils$mediator$transport$Transport$$receiveMessageEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$8, f)
}
function $s_Lutils_mediator_transport_Transport$class__send__Lutils_mediator_transport_Transport__T__V($$this, data) {
  var this$1 = $$this.utils$mediator$transport$Transport$$sendRawMessageListeners$1;
  $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$1, data);
  $s_Lutils_mediator_transport_SocketIOTransport$class__internalSend__Lutils_mediator_transport_SocketIOTransport__T__V($$this, data)
}
function $is_Lutils_mediator_transport_TransportFactory(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lutils_mediator_transport_TransportFactory)))
}
function $as_Lutils_mediator_transport_TransportFactory(obj) {
  return (($is_Lutils_mediator_transport_TransportFactory(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "utils.mediator.transport.TransportFactory"))
}
function $isArrayOf_Lutils_mediator_transport_TransportFactory(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lutils_mediator_transport_TransportFactory)))
}
function $asArrayOf_Lutils_mediator_transport_TransportFactory(obj, depth) {
  return (($isArrayOf_Lutils_mediator_transport_TransportFactory(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lutils.mediator.transport.TransportFactory;", depth))
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
function $s_s_concurrent_Future$class__collect__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__s_concurrent_Future($$this, pf, executor) {
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, pf$1) {
    return (function(r$2) {
      return pf$1.applyOrElse__O__F1__O(r$2, new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$2) {
        return (function(t$2) {
          throw new $c_ju_NoSuchElementException().init___T(("Future.collect partial function is not defined at: " + t$2))
        })
      })($$this$1)))
    })
  })($$this, pf));
...
function $s_s_concurrent_Future$class__onFailure__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V($$this, pf, executor) {
  $$this.onComplete__F1__s_concurrent_ExecutionContext__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, pf$1) {
    return (function(x0$2$2) {
      ...
      if ($is_s_util_Failure(x0$2)) {
        var x2 = $as_s_util_Failure(x0$2);
        var t = x2.exception$2;
        var this$1 = $m_s_Predef$();
        return pf$1.applyOrElse__O__F1__O(t, this$1.singleton$und$less$colon$less$2)
      } else {
        return (void 0)
      }
    })
...
function $s_LCommunicatorAdapter$$anonfun$getJsContact$1$$anon$3__CommunicatorAdapter$$anonfun$$anon$$$outer__LCommunicatorAdapter$$anonfun$getJsContact$1$$anon$3__LCommunicatorAdapter$$anonfun$getJsContact$1($this) {
  return $as_LCommunicatorAdapter$$anonfun$getJsContact$1($this.$$outer$2)
}
/** @constructor */
function $c_LTransportService() {
  $c_O.call(this);
  this.adapter$1 = null
}
$c_LTransportService.prototype = new $h_O();
$c_LTransportService.prototype.constructor = $c_LTransportService;
/** @constructor */
function $h_LTransportService() {
  /*<skip>*/
}
$h_LTransportService.prototype = $c_LTransportService.prototype;
$c_LTransportService.prototype.$$js$exported$meth$listenNewUsers__Lshared_entities_FacadeTypes$JsSubject__O = (function(subject) {
  this.adapter$1.onStatusChanged__Lshared_entities_FacadeTypes$JsSubject__V(subject)
});
$c_LTransportService.prototype.sendMessage__Lshared_entities_FacadeTypes$JsMessage__V = (function(message) {
  var info = new $c_Lshared_entities_ChatEntities$UserFullInfo().init___Lshared_entities_ChatEntities$UserReference__Lshared_entities_ChatEntities$UserInfo__Lshared_entities_ChatEntities$Status(new $c_Lshared_entities_ChatEntities$UserReference().init___T($as_T(message.contactInfo.contactReference.id)), new $c_Lshared_entities_ChatEntities$UserInfo().init___T__T($as_T(message.contactInfo.name), $as_T(message.contactInfo.avatar)), $m_Lshared_entities_ChatEntities$Online$());
  var m = new $c_Lshared_entities_ChatEntities$AddMessage().init___Lshared_entities_ChatEntities$Message(new $c_Lshared_entities_ChatEntities$Message().init___Lshared_entities_ChatEntities$DialogReference__Lshared_entities_ChatEntities$UserFullInfo__T__Lshared_entities_ChatEntities$Date(new $c_Lshared_entities_ChatEntities$DialogReference().init___T($as_T(message.dialogReference.id)), info, $as_T(message.value), new $c_Lshared_entities_ChatEntities$Date().init___T("")));
  var this$1 = this.adapter$1;
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(m);
  this$1.communicator$1.send__O__Lshared_utils_TransportEncoder__V(value, $m_Lshared_utils_TextTransportSerializers$stringEncoder$())
});
$c_LTransportService.prototype.$$js$exported$meth$listContacts__O = (function() {
  return this.listContacts__sjs_js_Promise()
});
$c_LTransportService.prototype.$$js$exported$meth$listDialogs__Lshared_entities_FacadeTypes$JsContactReference__O = (function(reference) {
  return this.listDialogs__Lshared_entities_FacadeTypes$JsContactReference__sjs_js_Promise(reference)
});
$c_LTransportService.prototype.addUser__Lshared_entities_FacadeTypes$JsUserInfo__sjs_js_Promise = (function(userInfo) {
  var this$2 = this.adapter$1;
  var this$1 = new $c_Lshared_entities_ChatEntities$AddUser().init___Lshared_entities_ChatEntities$UserInfo(new $c_Lshared_entities_ChatEntities$UserInfo().init___T__T($as_T(userInfo.name), $as_T(userInfo.avatarUrl)));
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$1);
  var this$4 = this$2.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$6 = this$4.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$UserAddingEvent.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$UserAddingEvent.getClassOf())) : $d_Lshared_entities_ChatEntities$UserAddingEvent.getClassOf());
  ...
  var this$9 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$6, f, ec);
  var pf = new $c_LTransportService$$anonfun$addUser$1().init___LTransportService(this);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var this$10 = $s_s_concurrent_Future$class__collect__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__s_concurrent_Future(this$9, pf, executor);
  var f$1 = new $c_LTransportService$$anonfun$addUser$2().init___LTransportService(this);
  var executor$1 = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var f$2 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$10, f$1, executor$1);
  var evidence$1 = new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_Lshared_entities_FacadeTypes$JsContactInfo.getClassOf());
  return new $c_Lutils_Utils$FutureObjectExtension().init___s_concurrent_Future__s_reflect_ClassTag(f$2, evidence$1).toDefaultPromise__sjs_js_Promise()
});
$c_LTransportService.prototype.listDialogs__Lshared_entities_FacadeTypes$JsContactReference__sjs_js_Promise = (function(reference) {
  var this$2 = this.adapter$1;
  var this$1 = new $c_Lshared_entities_ChatEntities$ListDialogs().init___Lshared_entities_ChatEntities$UserReference(new $c_Lshared_entities_ChatEntities$UserReference().init___T($as_T(reference.id)));
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$1);
  var this$4 = this$2.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$6 = this$4.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$Dialogs.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$Dialogs.getClassOf())) : $d_Lshared_entities_ChatEntities$Dialogs.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  var this$9 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$6, f, ec);
  var f$1 = new $c_LTransportService$$anonfun$listDialogs$1().init___LTransportService(this);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var this$14 = $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$9, f$1, executor);
  ...
  var executor$1 = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var f$3 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$14, f$2, executor$1);
  var evidence$1 = new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_sjs_js_Array.getClassOf());
  return new $c_Lutils_Utils$FutureObjectExtension().init___s_concurrent_Future__s_reflect_ClassTag(f$3, evidence$1).toDefaultPromise__sjs_js_Promise()
});
$c_LTransportService.prototype.$$js$exported$meth$sendConnect__Lshared_entities_FacadeTypes$JsContactReference__O = (function(reference) {
  this.sendConnect__Lshared_entities_FacadeTypes$JsContactReference__V(reference)
});
$c_LTransportService.prototype.$$js$exported$meth$sendMessage__Lshared_entities_FacadeTypes$JsMessage__O = (function(message) {
  this.sendMessage__Lshared_entities_FacadeTypes$JsMessage__V(message)
});
$c_LTransportService.prototype.$$js$exported$prop$adapter__O = (function() {
  return this.adapter$1
});
$c_LTransportService.prototype.getDialogInfo__Lshared_entities_FacadeTypes$JsDialogReference__sjs_js_Promise = (function(reference) {
  var f = this.adapter$1.getJsDialog__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future(new $c_Lshared_entities_ChatEntities$DialogReference().init___T($as_T(reference.id)));
  var evidence$1 = new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_Lshared_entities_FacadeTypes$JsDialogInfo.getClassOf());
  return new $c_Lutils_Utils$FutureObjectExtension().init___s_concurrent_Future__s_reflect_ClassTag(f, evidence$1).toDefaultPromise__sjs_js_Promise()
});
$c_LTransportService.prototype.$$js$exported$meth$listMessages__Lshared_entities_FacadeTypes$JsDialogReference__O = (function(reference) {
  return this.listMessages__Lshared_entities_FacadeTypes$JsDialogReference__sjs_js_Promise(reference)
});
$c_LTransportService.prototype.init___Lshared_entities_FacadeTypes$SocketIO = (function(socket) {
  this.adapter$1 = new $c_LCommunicatorAdapter().init___Lshared_entities_FacadeTypes$SocketIO(socket);
  return this
});
$c_LTransportService.prototype.$$js$exported$meth$addUser__Lshared_entities_FacadeTypes$JsUserInfo__O = (function(userInfo) {
  return this.addUser__Lshared_entities_FacadeTypes$JsUserInfo__sjs_js_Promise(userInfo)
});
$c_LTransportService.prototype.$$js$exported$meth$getOrCreateDialog__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsContactReference__O = (function(user1, user2) {
  return this.getOrCreateDialog__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsContactReference__sjs_js_Promise(user1, user2)
});
$c_LTransportService.prototype.sendConnect__Lshared_entities_FacadeTypes$JsContactReference__V = (function(reference) {
  var this$2 = this.adapter$1;
  var this$1 = new $c_Lshared_entities_ChatEntities$Connect().init___Lshared_entities_ChatEntities$UserReference(new $c_Lshared_entities_ChatEntities$UserReference().init___T($as_T(reference.id)));
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$1);
  this$2.communicator$1.send__O__Lshared_utils_TransportEncoder__V(value, $m_Lshared_utils_TextTransportSerializers$stringEncoder$())
});
$c_LTransportService.prototype.$$js$exported$meth$logout__Lshared_entities_FacadeTypes$JsContactInfo__O = (function(contactInfo) {
  this.logout__Lshared_entities_FacadeTypes$JsContactInfo__V(contactInfo)
});
$c_LTransportService.prototype.listMessages__Lshared_entities_FacadeTypes$JsDialogReference__sjs_js_Promise = (function(reference) {
  var this$1 = this.adapter$1.getMessages__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future(new $c_Lshared_entities_ChatEntities$DialogReference().init___T($as_T(reference.id)));
  var f = new $c_LTransportService$$anonfun$listMessages$1().init___LTransportService(this);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var f$1 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$1, f, executor);
  var evidence$1 = new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_sjs_js_Array.getClassOf());
  return new $c_Lutils_Utils$FutureObjectExtension().init___s_concurrent_Future__s_reflect_ClassTag(f$1, evidence$1).toDefaultPromise__sjs_js_Promise()
});
$c_LTransportService.prototype.$$js$exported$meth$listenNewMessages__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsSubject__O = (function(user, subject) {
  this.adapter$1.onMessage__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsSubject__V(user, subject)
});
$c_LTransportService.prototype.$$js$exported$meth$getDialogInfo__Lshared_entities_FacadeTypes$JsDialogReference__O = (function(reference) {
  return this.getDialogInfo__Lshared_entities_FacadeTypes$JsDialogReference__sjs_js_Promise(reference)
});
$c_LTransportService.prototype.logout__Lshared_entities_FacadeTypes$JsContactInfo__V = (function(contactInfo) {
  var this$1 = this.adapter$1;
  var value = $as_T(contactInfo.contactReference.id);
  this$1.communicator$1.send__O__Lshared_utils_TransportEncoder__V(value, $m_Lshared_utils_TextTransportSerializers$stringEncoder$())
});
$c_LTransportService.prototype.listContacts__sjs_js_Promise = (function() {
  var this$2 = this.adapter$1;
  var this$1 = new $c_Lshared_entities_ChatEntities$ListUsers().init___();
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$1);
  var this$4 = this$2.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$6 = this$4.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$Users.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$Users.getClassOf())) : $d_Lshared_entities_ChatEntities$Users.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  var this$9 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$6, f, ec);
  var f$1 = new $c_LTransportService$$anonfun$listContacts$1().init___LTransportService(this);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var this$14 = $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$9, f$1, executor);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$2) {
    var x$2 = $as_sci_List(x$2$2);
    if ($is_sjs_js_ArrayOps(x$2)) {
      var x2 = $as_sjs_js_ArrayOps(x$2);
      return x2.scala$scalajs$js$ArrayOps$$array$f
    } else if ($is_sjs_js_WrappedArray(x$2)) {
      var x3 = $as_sjs_js_WrappedArray(x$2);
      return x3.array$6
    } else {
      var result = [];
      var these = x$2;
...
$c_LTransportService.prototype.getOrCreateDialog__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsContactReference__sjs_js_Promise = (function(user1, user2) {
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lshared_entities_ChatEntities$UserReference().init___T($as_T(user1.id)), new $c_Lshared_entities_ChatEntities$UserReference().init___T($as_T(user2.id))]);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  var users = new $c_Lshared_entities_ChatEntities$Users().init___sci_List($as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)));
  var this$4 = this.adapter$1;
  var this$3 = new $c_Lshared_entities_ChatEntities$GetDialog().init___Lshared_entities_ChatEntities$Users(users);
  var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$3);
  var this$6 = this$4.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$8 = this$6.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$DialogReferenceOpt.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$DialogReferenceOpt.getClassOf())) : $d_Lshared_entities_ChatEntities$DialogReferenceOpt.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  var this$11 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$8, f, ec);
  var f$1 = new $c_LTransportService$$anonfun$getOrCreateDialog$1().init___LTransportService__Lshared_entities_ChatEntities$Users(this, users);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var this$12 = $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$11, f$1, executor);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(reference$2) {
      var reference = $as_Lshared_entities_ChatEntities$DialogReference(reference$2);
      return arg$outer.adapter$1.getJsDialog__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future(reference)
    })
  })(this));
  var executor$1 = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  var f$3 = $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$12, f$2, executor$1);
  var evidence$1 = new $c_s_reflect_ClassTag$ClassClassTag().init___jl_Class($d_Lshared_entities_FacadeTypes$JsDialogInfo.getClassOf());
  return new $c_Lutils_Utils$FutureObjectExtension().init___s_concurrent_Future__s_reflect_ClassTag(f$3, evidence$1).toDefaultPromise__sjs_js_Promise()
});
$c_LTransportService.prototype.logout = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$logout__Lshared_entities_FacadeTypes$JsContactInfo__O(prep0)
});
$c_LTransportService.prototype.sendMessage = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$sendMessage__Lshared_entities_FacadeTypes$JsMessage__O(prep0)
});
$c_LTransportService.prototype.listMessages = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$listMessages__Lshared_entities_FacadeTypes$JsDialogReference__O(prep0)
});
$c_LTransportService.prototype.getDialogInfo = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$getDialogInfo__Lshared_entities_FacadeTypes$JsDialogReference__O(prep0)
});
$c_LTransportService.prototype.getOrCreateDialog = (function(arg$1, arg$2) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  return this.$$js$exported$meth$getOrCreateDialog__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsContactReference__O(prep0, prep1)
});
$c_LTransportService.prototype.listDialogs = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$listDialogs__Lshared_entities_FacadeTypes$JsContactReference__O(prep0)
});
$c_LTransportService.prototype.listContacts = (function() {
  return this.$$js$exported$meth$listContacts__O()
});
$c_LTransportService.prototype.listenNewUsers = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$listenNewUsers__Lshared_entities_FacadeTypes$JsSubject__O(prep0)
});
$c_LTransportService.prototype.listenNewMessages = (function(arg$1, arg$2) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  return this.$$js$exported$meth$listenNewMessages__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsSubject__O(prep0, prep1)
});
$c_LTransportService.prototype.sendConnect = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$sendConnect__Lshared_entities_FacadeTypes$JsContactReference__O(prep0)
});
$c_LTransportService.prototype.addUser = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$addUser__Lshared_entities_FacadeTypes$JsUserInfo__O(prep0)
});
Object.defineProperty($c_LTransportService.prototype, "adapter", {
  "get": (function() {
    return this.$$js$exported$prop$adapter__O()
  }),
  "configurable": true
});
var $d_LTransportService = new $TypeData().initClass({
  LTransportService: 0
}, false, "TransportService", {
  LTransportService: 1,
  O: 1
});
$c_LTransportService.prototype.$classData = $d_LTransportService;
/** @constructor */
function $c_Lshared_Common$() {
  $c_O.call(this)
}
$c_Lshared_Common$.prototype = new $h_O();
$c_Lshared_Common$.prototype.constructor = $c_Lshared_Common$;
/** @constructor */
function $h_Lshared_Common$() {
  /*<skip>*/
}
$h_Lshared_Common$.prototype = $c_Lshared_Common$.prototype;
$c_Lshared_Common$.prototype.init___ = (function() {
  return this
});
$c_Lshared_Common$.prototype.generateUid__T = (function() {
  var x = $m_ju_UUID$().randomUUID__ju_UUID().toString__T();
  var this$2 = new $c_sci_StringOps().init___T(x);
  return $as_T($s_sc_IndexedSeqOptimized$class__takeRight__sc_IndexedSeqOptimized__I__O(this$2, 12))
});
var $d_Lshared_Common$ = new $TypeData().initClass({
  Lshared_Common$: 0
}, false, "shared.Common$", {
  Lshared_Common$: 1,
  O: 1
});
$c_Lshared_Common$.prototype.$classData = $d_Lshared_Common$;
var $n_Lshared_Common$ = (void 0);
function $m_Lshared_Common$() {
  if ((!$n_Lshared_Common$)) {
    $n_Lshared_Common$ = new $c_Lshared_Common$().init___()
  };
  return $n_Lshared_Common$
}
/** @constructor */
function $c_Lutils_Utils$FutureObjectExtension() {
  $c_O.call(this);
  this.utils$Utils$FutureObjectExtension$$f$f = null
}
$c_Lutils_Utils$FutureObjectExtension.prototype = new $h_O();
$c_Lutils_Utils$FutureObjectExtension.prototype.constructor = $c_Lutils_Utils$FutureObjectExtension;
/** @constructor */
function $h_Lutils_Utils$FutureObjectExtension() {
  /*<skip>*/
}
$h_Lutils_Utils$FutureObjectExtension.prototype = $c_Lutils_Utils$FutureObjectExtension.prototype;
$c_Lutils_Utils$FutureObjectExtension.prototype.toDefaultPromise__sjs_js_Promise = (function() {
  return this.toPromise__F1__s_concurrent_ExecutionContext__sjs_js_Promise(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_jl_Throwable(x$1$2);
    var s = x$1.getMessage__T();
    return s
  })), $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor())
});
$c_Lutils_Utils$FutureObjectExtension.prototype.toPromise__F1__s_concurrent_ExecutionContext__sjs_js_Promise = (function(recovery, ec) {
  return new $g.Promise((function(f) {
    return (function(arg1, arg2) {
      return f.apply__O__O__O(arg1, arg2)
    })
  })(new $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1().init___Lutils_Utils$FutureObjectExtension__F1(this, recovery)))
});
$c_Lutils_Utils$FutureObjectExtension.prototype.init___s_concurrent_Future__s_reflect_ClassTag = (function(f, evidence$1) {
  this.utils$Utils$FutureObjectExtension$$f$f = f;
  return this
});
var $d_Lutils_Utils$FutureObjectExtension = new $TypeData().initClass({
  Lutils_Utils$FutureObjectExtension: 0
}, false, "utils.Utils$FutureObjectExtension", {
  Lutils_Utils$FutureObjectExtension: 1,
  O: 1
});
$c_Lutils_Utils$FutureObjectExtension.prototype.$classData = $d_Lutils_Utils$FutureObjectExtension;
/** @constructor */
function $c_Lutils_mediator_strategies_ReconnectStrategy$() {
  $c_O.call(this);
  this.defaultStrategy$1 = null
}
$c_Lutils_mediator_strategies_ReconnectStrategy$.prototype = new $h_O();
$c_Lutils_mediator_strategies_ReconnectStrategy$.prototype.constructor = $c_Lutils_mediator_strategies_ReconnectStrategy$;
/** @constructor */
function $h_Lutils_mediator_strategies_ReconnectStrategy$() {
  /*<skip>*/
}
$h_Lutils_mediator_strategies_ReconnectStrategy$.prototype = $c_Lutils_mediator_strategies_ReconnectStrategy$.prototype;
$c_Lutils_mediator_strategies_ReconnectStrategy$.prototype.init___ = (function() {
  $n_Lutils_mediator_strategies_ReconnectStrategy$ = this;
  this.defaultStrategy$1 = $m_Lutils_mediator_strategies_roundRobinStrategy$();
  return this
});
var $d_Lutils_mediator_strategies_ReconnectStrategy$ = new $TypeData().initClass({
  Lutils_mediator_strategies_ReconnectStrategy$: 0
}, false, "utils.mediator.strategies.ReconnectStrategy$", {
  Lutils_mediator_strategies_ReconnectStrategy$: 1,
  O: 1
});
$c_Lutils_mediator_strategies_ReconnectStrategy$.prototype.$classData = $d_Lutils_mediator_strategies_ReconnectStrategy$;
var $n_Lutils_mediator_strategies_ReconnectStrategy$ = (void 0);
function $m_Lutils_mediator_strategies_ReconnectStrategy$() {
  if ((!$n_Lutils_mediator_strategies_ReconnectStrategy$)) {
    $n_Lutils_mediator_strategies_ReconnectStrategy$ = new $c_Lutils_mediator_strategies_ReconnectStrategy$().init___()
  };
  return $n_Lutils_mediator_strategies_ReconnectStrategy$
}
/** @constructor */
function $c_Lutils_mediator_transport_SocketIOTransport$() {
  $c_O.call(this)
}
$c_Lutils_mediator_transport_SocketIOTransport$.prototype = new $h_O();
$c_Lutils_mediator_transport_SocketIOTransport$.prototype.constructor = $c_Lutils_mediator_transport_SocketIOTransport$;
/** @constructor */
function $h_Lutils_mediator_transport_SocketIOTransport$() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_SocketIOTransport$.prototype = $c_Lutils_mediator_transport_SocketIOTransport$.prototype;
$c_Lutils_mediator_transport_SocketIOTransport$.prototype.init___ = (function() {
  return this
});
$c_Lutils_mediator_transport_SocketIOTransport$.prototype.apply__Lutils_mediator_transport_SocketIOConfig__Lutils_mediator_transport_Transport = (function(config) {
  var t = new $c_Lutils_mediator_transport_SocketIOTransport$$anon$2().init___();
  $s_Lutils_mediator_transport_Transport$class__setConfig__Lutils_mediator_transport_Transport__O__V(t, config);
  return t
});
var $d_Lutils_mediator_transport_SocketIOTransport$ = new $TypeData().initClass({
  Lutils_mediator_transport_SocketIOTransport$: 0
}, false, "utils.mediator.transport.SocketIOTransport$", {
  Lutils_mediator_transport_SocketIOTransport$: 1,
  O: 1
});
$c_Lutils_mediator_transport_SocketIOTransport$.prototype.$classData = $d_Lutils_mediator_transport_SocketIOTransport$;
var $n_Lutils_mediator_transport_SocketIOTransport$ = (void 0);
function $m_Lutils_mediator_transport_SocketIOTransport$() {
  if ((!$n_Lutils_mediator_transport_SocketIOTransport$)) {
    $n_Lutils_mediator_transport_SocketIOTransport$ = new $c_Lutils_mediator_transport_SocketIOTransport$().init___()
  };
  return $n_Lutils_mediator_transport_SocketIOTransport$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Lshared_utils_TextTransportSerializers$$anon$1() {
  $c_O.call(this)
}
$c_Lshared_utils_TextTransportSerializers$$anon$1.prototype = new $h_O();
$c_Lshared_utils_TextTransportSerializers$$anon$1.prototype.constructor = $c_Lshared_utils_TextTransportSerializers$$anon$1;
/** @constructor */
function $h_Lshared_utils_TextTransportSerializers$$anon$1() {
  /*<skip>*/
}
$h_Lshared_utils_TextTransportSerializers$$anon$1.prototype = $c_Lshared_utils_TextTransportSerializers$$anon$1.prototype;
$c_Lshared_utils_TextTransportSerializers$$anon$1.prototype.init___ = (function() {
  return this
});
var $d_Lshared_utils_TextTransportSerializers$$anon$1 = new $TypeData().initClass({
  Lshared_utils_TextTransportSerializers$$anon$1: 0
}, false, "shared.utils.TextTransportSerializers$$anon$1", {
  Lshared_utils_TextTransportSerializers$$anon$1: 1,
  O: 1,
  Lshared_utils_TransportSerializer: 1
});
$c_Lshared_utils_TextTransportSerializers$$anon$1.prototype.$classData = $d_Lshared_utils_TextTransportSerializers$$anon$1;
/** @constructor */
function $c_Lutils_mediator_CommunicatorOps() {
  $c_O.call(this);
  this.reconnectStrategy$1 = null;
  this.ts$1 = null;
  this.reconnectionTimeout$1 = 0;
  this.requests$1 = null;
  this.stashedMessages$1 = null;
  this.transports$1 = null;
  this.utils$mediator$CommunicatorOps$$messageEventListeners$1 = null;
  this.utils$mediator$CommunicatorOps$$connected$1 = false;
  this.utils$mediator$CommunicatorOps$$internalSend$1 = null
}
$c_Lutils_mediator_CommunicatorOps.prototype = new $h_O();
$c_Lutils_mediator_CommunicatorOps.prototype.constructor = $c_Lutils_mediator_CommunicatorOps;
/** @constructor */
function $h_Lutils_mediator_CommunicatorOps() {
  /*<skip>*/
}
$h_Lutils_mediator_CommunicatorOps.prototype = $c_Lutils_mediator_CommunicatorOps.prototype;
$c_Lutils_mediator_CommunicatorOps.prototype.onDecodedMessage__F1__Lshared_utils_TransportDecoder__V = (function(f, decoder) {
  this.onMessage__F1__Lshared_utils_TransportDecoder__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$2) {
    return (function(x$2) {
      var x = $as_s_util_Either(x$2);
      if ($is_s_util_Right(x)) {
        var x2 = $as_s_util_Right(x);
        var m = x2.b$2;
        $asUnit(f$2.apply__O__O(m))
...
$c_Lutils_mediator_CommunicatorOps.prototype.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future = (function(q, as) {
  var uid = new $c_Lshared_Common$UID().init___T($m_Lshared_Common$().generateUid__T());
  var value = $as_T(q);
  var p = new $c_s_concurrent_impl_Promise$DefaultPromise().init___();
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(p$1) {
    return (function(response$2) {
      var response = $as_Lshared_Common$ResponseMessage(response$2);
      var x1 = response.transportMessage__Lshared_Common$TransportMessage();
      var e = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["unknown transport message type. required PlainMessage received: '", "'"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([x1]));
      var cause = new $c_jl_Throwable().init___T(e);
      $s_s_concurrent_Promise$class__failure__s_concurrent_Promise__jl_Throwable__s_concurrent_Promise(p$1, cause)
    })
  })(p));
  this.requests$1 = this.requests$1.$$plus__T2__sci_Map(new $c_T2().init___O__O(uid, f));
  this.send__O__Lshared_utils_TransportEncoder__V(value, $m_Lshared_utils_TextTransportSerializers$stringEncoder$());
  return p
});
$c_Lutils_mediator_CommunicatorOps.prototype.addTransport__Lutils_mediator_transport_TransportFactory__V = (function(t) {
  var jsx$1 = this.transports$1;
  var this$1 = $m_sci_Queue$();
  this.transports$1 = $as_sci_Queue(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(t, this$1.ReusableCBFInstance$2))
});
$c_Lutils_mediator_CommunicatorOps.prototype.utils$mediator$CommunicatorOps$$stash__T__V = (function(message) {
  this.stashedMessages$1 = this.stashedMessages$1.enqueue__O__sci_Queue(message)
});
$c_Lutils_mediator_CommunicatorOps.prototype.init___Lutils_mediator_strategies_ReconnectStrategy__Lshared_utils_TransportSerializer = (function(reconnectStrategy, ts) {
  this.reconnectStrategy$1 = reconnectStrategy;
  this.ts$1 = ts;
  this.reconnectionTimeout$1 = 10000;
  this.requests$1 = $m_sci_Map$EmptyMap$();
  $m_sci_Queue$();
  var xs = $m_sci_Nil$();
  this.stashedMessages$1 = new $c_sci_Queue().init___sci_List__sci_List($m_sci_Nil$(), xs);
  this.transports$1 = ($m_sci_Queue$(), $m_sci_Queue$EmptyQueue$());
  this.utils$mediator$CommunicatorOps$$messageEventListeners$1 = ($m_sci_List$(), $m_sci_Nil$());
  this.utils$mediator$CommunicatorOps$$connected$1 = false;
  this.utils$mediator$CommunicatorOps$$internalSend$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(message$2) {
      var message = $as_T(message$2);
      arg$outer.utils$mediator$CommunicatorOps$$stash__T__V(message)
    })
  })(this));
  this.onDecodedMessage__F1__Lshared_utils_TransportDecoder__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x0$1$2) {
    $as_T(x0$1$2)
  })), $m_Lshared_utils_TextTransportSerializers$stringDecoder$());
  return this
});
$c_Lutils_mediator_CommunicatorOps.prototype.send__O__Lshared_utils_TransportEncoder__V = (function(message, encoder) {
  var jsx$1 = this.utils$mediator$CommunicatorOps$$internalSend$1;
  var value = $as_T(message);
  jsx$1.apply__O__O(value)
});
$c_Lutils_mediator_CommunicatorOps.prototype.utils$mediator$CommunicatorOps$$reconnect__V = (function() {
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(this.reconnectionTimeout$1, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      arg$outer.connect__V()
    })
  })(this)))
});
$c_Lutils_mediator_CommunicatorOps.prototype.utils$mediator$CommunicatorOps$$unstashAll__V = (function() {
  var q = this.stashedMessages$1;
  $m_sci_Queue$();
  var xs = $m_sci_Nil$();
  this.stashedMessages$1 = new $c_sci_Queue().init___sci_List__sci_List($m_sci_Nil$(), xs);
  var f = this.utils$mediator$CommunicatorOps$$internalSend$1;
  var this$2 = q.iterator__sc_Iterator();
  $s_sc_Iterator$class__foreach__sc_Iterator__F1__V(this$2, f)
});
$c_Lutils_mediator_CommunicatorOps.prototype.connect__V = (function() {
  var this$1 = this.reconnectStrategy$1;
  var transports = this.transports$1;
  var block = new $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1().init___Lutils_mediator_CommunicatorOps(this);
  this.transports$1 = $s_Lutils_mediator_strategies_ReconnectStrategy$class__apply__Lutils_mediator_strategies_ReconnectStrategy__sci_Queue__F1__sci_Queue(this$1, transports, block)
});
$c_Lutils_mediator_CommunicatorOps.prototype.onMessage__F1__Lshared_utils_TransportDecoder__V = (function(f, decoder) {
  var listener = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(f$1, decoder$1) {
    return (function(message$2) {
      var message = $as_T(message$2);
      $m_s_package$();
      var s = new $c_s_util_Right().init___O(message);
      f$1.apply__O__O(s)
    })
  })(f, decoder));
  var jsx$1 = this.utils$mediator$CommunicatorOps$$messageEventListeners$1;
  var this$2 = $m_sci_List$();
  this.utils$mediator$CommunicatorOps$$messageEventListeners$1 = $as_sci_List(jsx$1.$$plus$colon__O__scg_CanBuildFrom__O(listener, this$2.ReusableCBFInstance$2))
});
var $d_Lutils_mediator_CommunicatorOps = new $TypeData().initClass({
  Lutils_mediator_CommunicatorOps: 0
}, false, "utils.mediator.CommunicatorOps", {
  Lutils_mediator_CommunicatorOps: 1,
  O: 1,
  Lutils_mediator_Communicator: 1
});
$c_Lutils_mediator_CommunicatorOps.prototype.$classData = $d_Lutils_mediator_CommunicatorOps;
/** @constructor */
function $c_Lutils_mediator_Listener$$anon$1() {
  $c_O.call(this);
  this.listeners$1 = null
}
$c_Lutils_mediator_Listener$$anon$1.prototype = new $h_O();
$c_Lutils_mediator_Listener$$anon$1.prototype.constructor = $c_Lutils_mediator_Listener$$anon$1;
/** @constructor */
function $h_Lutils_mediator_Listener$$anon$1() {
  /*<skip>*/
}
$h_Lutils_mediator_Listener$$anon$1.prototype = $c_Lutils_mediator_Listener$$anon$1.prototype;
$c_Lutils_mediator_Listener$$anon$1.prototype.init___ = (function() {
  this.listeners$1 = ($m_sci_List$(), $m_sci_Nil$());
  return this
});
var $d_Lutils_mediator_Listener$$anon$1 = new $TypeData().initClass({
  Lutils_mediator_Listener$$anon$1: 0
}, false, "utils.mediator.Listener$$anon$1", {
  Lutils_mediator_Listener$$anon$1: 1,
  O: 1,
  Lutils_mediator_Listener: 1
});
$c_Lutils_mediator_Listener$$anon$1.prototype.$classData = $d_Lutils_mediator_Listener$$anon$1;
/** @constructor */
function $c_Lutils_mediator_strategies_roundRobinStrategy$() {
  $c_O.call(this)
}
$c_Lutils_mediator_strategies_roundRobinStrategy$.prototype = new $h_O();
$c_Lutils_mediator_strategies_roundRobinStrategy$.prototype.constructor = $c_Lutils_mediator_strategies_roundRobinStrategy$;
/** @constructor */
function $h_Lutils_mediator_strategies_roundRobinStrategy$() {
  /*<skip>*/
}
$h_Lutils_mediator_strategies_roundRobinStrategy$.prototype = $c_Lutils_mediator_strategies_roundRobinStrategy$.prototype;
$c_Lutils_mediator_strategies_roundRobinStrategy$.prototype.init___ = (function() {
  return this
});
$c_Lutils_mediator_strategies_roundRobinStrategy$.prototype.process__sci_Queue__T2 = (function(transports) {
  if (transports.isEmpty__Z()) {
    return new $c_T2().init___O__O($m_s_None$(), transports)
  } else {
    var x1 = transports.dequeue__T2();
    if ((x1 === null)) {
      throw new $c_s_MatchError().init___O(x1)
    };
    var tf = $as_Lutils_mediator_transport_TransportFactory(x1.$$und1$f);
    var ts = $as_sci_Queue(x1.$$und2$f);
    return new $c_T2().init___O__O(new $c_s_Some().init___O(tf), ts.enqueue__O__sci_Queue(tf))
  }
});
var $d_Lutils_mediator_strategies_roundRobinStrategy$ = new $TypeData().initClass({
  Lutils_mediator_strategies_roundRobinStrategy$: 0
}, false, "utils.mediator.strategies.roundRobinStrategy$", {
  Lutils_mediator_strategies_roundRobinStrategy$: 1,
  O: 1,
  Lutils_mediator_strategies_ReconnectStrategy: 1
});
$c_Lutils_mediator_strategies_roundRobinStrategy$.prototype.$classData = $d_Lutils_mediator_strategies_roundRobinStrategy$;
var $n_Lutils_mediator_strategies_roundRobinStrategy$ = (void 0);
function $m_Lutils_mediator_strategies_roundRobinStrategy$() {
  if ((!$n_Lutils_mediator_strategies_roundRobinStrategy$)) {
    $n_Lutils_mediator_strategies_roundRobinStrategy$ = new $c_Lutils_mediator_strategies_roundRobinStrategy$().init___()
  };
  return $n_Lutils_mediator_strategies_roundRobinStrategy$
}
/** @constructor */
...
$c_jl_Throwable.prototype.init___T = (function(s) {
...
var $d_jl_Throwable = new $TypeData().initClass({
  jl_Throwable: 0
...
$c_jl_Throwable.prototype.$classData = $d_jl_Throwable;
/** @constructor */
...
/** @constructor */
function $c_Lshared_utils_TextTransportSerializers$stringDecoder$() {
  $c_O.call(this)
}
$c_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype = new $h_O();
$c_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype.constructor = $c_Lshared_utils_TextTransportSerializers$stringDecoder$;
/** @constructor */
function $h_Lshared_utils_TextTransportSerializers$stringDecoder$() {
  /*<skip>*/
}
$h_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype = $c_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype;
$c_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype.init___ = (function() {
  return this
});
var $d_Lshared_utils_TextTransportSerializers$stringDecoder$ = new $TypeData().initClass({
  Lshared_utils_TextTransportSerializers$stringDecoder$: 0
}, false, "shared.utils.TextTransportSerializers$stringDecoder$", {
  Lshared_utils_TextTransportSerializers$stringDecoder$: 1,
  O: 1,
  Lshared_utils_TransportDecoder: 1,
  Lshared_utils_MessageTransformer: 1
});
$c_Lshared_utils_TextTransportSerializers$stringDecoder$.prototype.$classData = $d_Lshared_utils_TextTransportSerializers$stringDecoder$;
var $n_Lshared_utils_TextTransportSerializers$stringDecoder$ = (void 0);
function $m_Lshared_utils_TextTransportSerializers$stringDecoder$() {
  if ((!$n_Lshared_utils_TextTransportSerializers$stringDecoder$)) {
    $n_Lshared_utils_TextTransportSerializers$stringDecoder$ = new $c_Lshared_utils_TextTransportSerializers$stringDecoder$().init___()
  };
  return $n_Lshared_utils_TextTransportSerializers$stringDecoder$
}
/** @constructor */
function $c_Lshared_utils_TextTransportSerializers$stringEncoder$() {
  $c_O.call(this)
}
$c_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype = new $h_O();
$c_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype.constructor = $c_Lshared_utils_TextTransportSerializers$stringEncoder$;
/** @constructor */
function $h_Lshared_utils_TextTransportSerializers$stringEncoder$() {
  /*<skip>*/
}
$h_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype = $c_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype;
$c_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype.init___ = (function() {
  return this
});
var $d_Lshared_utils_TextTransportSerializers$stringEncoder$ = new $TypeData().initClass({
  Lshared_utils_TextTransportSerializers$stringEncoder$: 0
}, false, "shared.utils.TextTransportSerializers$stringEncoder$", {
  Lshared_utils_TextTransportSerializers$stringEncoder$: 1,
  O: 1,
  Lshared_utils_TransportEncoder: 1,
  Lshared_utils_MessageTransformer: 1
});
$c_Lshared_utils_TextTransportSerializers$stringEncoder$.prototype.$classData = $d_Lshared_utils_TextTransportSerializers$stringEncoder$;
var $n_Lshared_utils_TextTransportSerializers$stringEncoder$ = (void 0);
function $m_Lshared_utils_TextTransportSerializers$stringEncoder$() {
  if ((!$n_Lshared_utils_TextTransportSerializers$stringEncoder$)) {
    $n_Lshared_utils_TextTransportSerializers$stringEncoder$ = new $c_Lshared_utils_TextTransportSerializers$stringEncoder$().init___()
  };
  return $n_Lshared_utils_TextTransportSerializers$stringEncoder$
}
/** @constructor */
function $c_Lutils_mediator_transport_SocketIOTransport$$anon$2() {
  $c_O.call(this);
  this.utils$mediator$transport$SocketIOTransport$$socket$1 = null;
  this.timeout$1 = 0;
  this.tryReconnect$1 = false;
  this.utils$mediator$transport$Transport$$connectEventListeners$1 = null;
  this.utils$mediator$transport$Transport$$disconnectEventListeners$1 = null;
  this.utils$mediator$transport$Transport$$errorEventListeners$1 = null;
  this.utils$mediator$transport$Transport$$receiveMessageEventListeners$1 = null;
  this.utils$mediator$transport$Transport$$sendRawMessageListeners$1 = null;
  this.utils$mediator$transport$Transport$$sendStringMessageListeners$1 = null;
  this.utils$mediator$transport$Transport$$internalConnected$1 = false;
  this.utils$mediator$transport$Transport$$currentConfig$1 = null
}
$c_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype = new $h_O();
$c_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype.constructor = $c_Lutils_mediator_transport_SocketIOTransport$$anon$2;
/** @constructor */
function $h_Lutils_mediator_transport_SocketIOTransport$$anon$2() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype = $c_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype;
$c_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype.init___ = (function() {
  $s_Lutils_mediator_transport_Transport$class__$$init$__Lutils_mediator_transport_Transport__V(this);
  $s_Lutils_mediator_transport_SocketIOTransport$class__$$init$__Lutils_mediator_transport_SocketIOTransport__V(this);
  return this
});
var $d_Lutils_mediator_transport_SocketIOTransport$$anon$2 = new $TypeData().initClass({
  Lutils_mediator_transport_SocketIOTransport$$anon$2: 0
}, false, "utils.mediator.transport.SocketIOTransport$$anon$2", {
  Lutils_mediator_transport_SocketIOTransport$$anon$2: 1,
  O: 1,
  Lutils_mediator_transport_SocketIOTransport: 1,
  Lutils_mediator_transport_Transport: 1
});
$c_Lutils_mediator_transport_SocketIOTransport$$anon$2.prototype.$classData = $d_Lutils_mediator_transport_SocketIOTransport$$anon$2;
/** @constructor */
function $c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1() {
  $c_O.call(this);
  this.c$1$1 = null
}
$c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype = new $h_O();
$c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype.constructor = $c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1;
/** @constructor */
function $h_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype = $c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype;
$c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype.init___Lutils_mediator_transport_SocketIOConfig = (function(c$1) {
  this.c$1$1 = c$1;
  return this
});
var $d_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1 = new $TypeData().initClass({
  Lutils_mediator_transport_SocketIOTransportFactory$$anon$1: 0
}, false, "utils.mediator.transport.SocketIOTransportFactory$$anon$1", {
  Lutils_mediator_transport_SocketIOTransportFactory$$anon$1: 1,
  O: 1,
  Lutils_mediator_transport_SocketIOTransportFactory: 1,
  Lutils_mediator_transport_TransportFactory: 1
});
$c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1.prototype.$classData = $d_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1;
...
/** @constructor */
function $c_LCommunicatorAdapter() {
  $c_O.call(this);
  this.socket$1 = null;
  this.communicator$1 = null
}
$c_LCommunicatorAdapter.prototype = new $h_O();
$c_LCommunicatorAdapter.prototype.constructor = $c_LCommunicatorAdapter;
/** @constructor */
function $h_LCommunicatorAdapter() {
  /*<skip>*/
}
$h_LCommunicatorAdapter.prototype = $c_LCommunicatorAdapter.prototype;
$c_LCommunicatorAdapter.prototype.productPrefix__T = (function() {
  return "CommunicatorAdapter"
});
$c_LCommunicatorAdapter.prototype.productArity__I = (function() {
  return 1
});
$c_LCommunicatorAdapter.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LCommunicatorAdapter(x$1)) {
    var CommunicatorAdapter$1 = $as_LCommunicatorAdapter(x$1);
    return $m_sr_BoxesRunTime$().equals__O__O__Z(this.socket$1, CommunicatorAdapter$1.socket$1)
  } else {
    return false
  }
});
$c_LCommunicatorAdapter.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_LCommunicatorAdapter.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LCommunicatorAdapter.prototype.onMessage__Lshared_entities_FacadeTypes$JsContactReference__Lshared_entities_FacadeTypes$JsSubject__V = (function(user, subject) {
  this.communicator$1.onDecodedMessage__F1__Lshared_utils_TransportDecoder__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x0$1$2) {
    $as_T(x0$1$2)
  })), $m_Lshared_utils_TextTransportSerializers$stringDecoder$())
});
$c_LCommunicatorAdapter.prototype.init___Lshared_entities_FacadeTypes$SocketIO = (function(socket) {
  this.socket$1 = socket;
  var c = new $c_Lutils_mediator_transport_SocketIOConfig().init___Lshared_entities_FacadeTypes$SocketIO(socket);
  var tf = new $c_Lutils_mediator_transport_SocketIOTransportFactory$$anon$1().init___Lutils_mediator_transport_SocketIOConfig(c);
  var array = [];
  var reconnectStrategy = $m_Lutils_mediator_strategies_ReconnectStrategy$().defaultStrategy$1;
  var ts = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var res = new $c_Lutils_mediator_CommunicatorOps().init___Lutils_mediator_strategies_ReconnectStrategy__Lshared_utils_TransportSerializer(reconnectStrategy, ts);
  res.addTransport__Lutils_mediator_transport_TransportFactory__V(tf);
  var i = 0;
  var len = $uI(array.length);
  while ((i < len)) {
    var index = i;
    var arg1 = array[index];
    var t = $as_Lutils_mediator_transport_TransportFactory(arg1);
    res.addTransport__Lutils_mediator_transport_TransportFactory__V(t);
    i = ((1 + i) | 0)
  };
  res.connect__V();
  this.communicator$1 = res;
  return this
});
$c_LCommunicatorAdapter.prototype.getJsContact__Lshared_entities_ChatEntities$UserReference__s_concurrent_Future = (function(userReference) {
  var value = userReference.id$1;
  var this$2 = this.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$4 = this$2.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$UserInfo.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$UserInfo.getClassOf())) : $d_Lshared_entities_ChatEntities$UserInfo.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  var this$7 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$4, f, ec);
  var f$1 = new $c_LCommunicatorAdapter$$anonfun$getJsContact$1().init___LCommunicatorAdapter__Lshared_entities_ChatEntities$UserReference(this, userReference);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$7, f$1, executor)
});
$c_LCommunicatorAdapter.prototype.onStatusChanged__Lshared_entities_FacadeTypes$JsSubject__V = (function(subject) {
  this.communicator$1.onDecodedMessage__F1__Lshared_utils_TransportDecoder__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x0$2$2) {
    $as_T(x0$2$2)
  })), $m_Lshared_utils_TextTransportSerializers$stringDecoder$())
});
$c_LCommunicatorAdapter.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LCommunicatorAdapter.prototype.getJsDialog__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future = (function(reference) {
  var value = reference.id$1;
  var this$2 = this.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$4 = this$2.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$DialogInfo.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$DialogInfo.getClassOf())) : $d_Lshared_entities_ChatEntities$DialogInfo.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  var this$7 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$4, f, ec);
  var f$1 = new $c_LCommunicatorAdapter$$anonfun$getJsDialog$1().init___LCommunicatorAdapter__Lshared_entities_ChatEntities$DialogReference(this, reference);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  return $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$7, f$1, executor)
});
$c_LCommunicatorAdapter.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LCommunicatorAdapter.prototype.getMessages__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future = (function(ref) {
  var value = ref.id$1;
  var this$2 = this.communicator$1;
  var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
  var this$4 = this$2.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
  var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
  var boxedClass = ($d_Lshared_entities_ChatEntities$Messages.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$Messages.getClassOf())) : $d_Lshared_entities_ChatEntities$Messages.getClassOf());
  $m_s_Predef$().require__Z__V((boxedClass !== null));
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
    return (function(s$2) {
      if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
  ...
  return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$4, f, ec)
});
$c_LCommunicatorAdapter.prototype.getJsMessage__Lshared_entities_ChatEntities$Message__Lshared_entities_FacadeTypes$JsMessage = (function(message) {
  var $this = {};
  $this.id = null;
  $this.id = message.dialogReference$1.id$1;
  var this$2 = {};
  this$2.contactReference = null;
  this$2.name = null;
  this$2.avatar = null;
  this$2.message$1$f = null;
  this$2.message$1$f = message;
  var $this$1 = {};
  $this$1.id = null;
  $this$1.id = $as_Lshared_entities_ChatEntities$Message(this$2.message$1$f).userFullInfo$1.userReference$1.id$1;
  this$2.contactReference = $this$1;
  this$2.name = message.userFullInfo$1.userInfo$1.name$1;
  this$2.avatar = message.userFullInfo$1.userInfo$1.avatarUrl$1;
  var this$3 = {};
  this$3.dialogReference = null;
  this$3.contactInfo = null;
  this$3.value = null;
  this$3.date = null;
  this$3.dialogReference = $this;
  this$3.contactInfo = this$2;
  this$3.value = message.value$1;
  this$3.date = message.date$1.value$1;
  return this$3
});
function $is_LCommunicatorAdapter(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LCommunicatorAdapter)))
}
function $as_LCommunicatorAdapter(obj) {
  return (($is_LCommunicatorAdapter(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "CommunicatorAdapter"))
}
function $isArrayOf_LCommunicatorAdapter(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LCommunicatorAdapter)))
}
function $asArrayOf_LCommunicatorAdapter(obj, depth) {
  return (($isArrayOf_LCommunicatorAdapter(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LCommunicatorAdapter;", depth))
}
var $d_LCommunicatorAdapter = new $TypeData().initClass({
  LCommunicatorAdapter: 0
}, false, "CommunicatorAdapter", {
  LCommunicatorAdapter: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_LCommunicatorAdapter.prototype.$classData = $d_LCommunicatorAdapter;
/** @constructor */
function $c_LCommunicatorAdapter$$anonfun$getJsContact$1() {
  $c_sr_AbstractFunction1.call(this);
  this.userReference$1$f = null
}
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype = new $h_sr_AbstractFunction1();
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype.constructor = $c_LCommunicatorAdapter$$anonfun$getJsContact$1;
/** @constructor */
function $h_LCommunicatorAdapter$$anonfun$getJsContact$1() {
  /*<skip>*/
}
$h_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype = $c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype;
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$UserInfo__Lshared_entities_FacadeTypes$JsContactInfo($as_Lshared_entities_ChatEntities$UserInfo(v1))
});
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype.apply__Lshared_entities_ChatEntities$UserInfo__Lshared_entities_FacadeTypes$JsContactInfo = (function(info) {
  var $this = {};
  ...
  var $this$1 = {};
  $this$1.id = null;
  $this$1.id = $s_LCommunicatorAdapter$$anonfun$getJsContact$1$$anon$3__CommunicatorAdapter$$anonfun$$anon$$$outer__LCommunicatorAdapter$$anonfun$getJsContact$1$$anon$3__LCommunicatorAdapter$$anonfun$getJsContact$1($this).userReference$1$f.id$1;
  $this.contactReference = $this$1;
  $this.name = info.name$1;
  $this.avatar = info.avatarUrl$1;
  return $this
});
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype.init___LCommunicatorAdapter__Lshared_entities_ChatEntities$UserReference = (function($$outer, userReference$1) {
  this.userReference$1$f = userReference$1;
  return this
});
function $is_LCommunicatorAdapter$$anonfun$getJsContact$1(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LCommunicatorAdapter$$anonfun$getJsContact$1)))
}
function $as_LCommunicatorAdapter$$anonfun$getJsContact$1(obj) {
  return (($is_LCommunicatorAdapter$$anonfun$getJsContact$1(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "CommunicatorAdapter$$anonfun$getJsContact$1"))
}
function $isArrayOf_LCommunicatorAdapter$$anonfun$getJsContact$1(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LCommunicatorAdapter$$anonfun$getJsContact$1)))
}
function $asArrayOf_LCommunicatorAdapter$$anonfun$getJsContact$1(obj, depth) {
  return (($isArrayOf_LCommunicatorAdapter$$anonfun$getJsContact$1(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LCommunicatorAdapter$$anonfun$getJsContact$1;", depth))
}
var $d_LCommunicatorAdapter$$anonfun$getJsContact$1 = new $TypeData().initClass({
  LCommunicatorAdapter$$anonfun$getJsContact$1: 0
}, false, "CommunicatorAdapter$$anonfun$getJsContact$1", {
  LCommunicatorAdapter$$anonfun$getJsContact$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LCommunicatorAdapter$$anonfun$getJsContact$1.prototype.$classData = $d_LCommunicatorAdapter$$anonfun$getJsContact$1;
/** @constructor */
function $c_LCommunicatorAdapter$$anonfun$getJsDialog$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.reference$1$f = null
}
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype = new $h_sr_AbstractFunction1();
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype.constructor = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1;
/** @constructor */
function $h_LCommunicatorAdapter$$anonfun$getJsDialog$1() {
  /*<skip>*/
}
$h_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype;
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$DialogInfo__s_concurrent_Future($as_Lshared_entities_ChatEntities$DialogInfo(v1))
});
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype.apply__Lshared_entities_ChatEntities$DialogInfo__s_concurrent_Future = (function(info) {
  var jsx$3 = $m_s_concurrent_Future$();
  var this$2 = info.users__Lshared_entities_ChatEntities$Users().value$1;
  var f = (function(arg$outer) {
    return (function(userReference$2) {
      var userReference = $as_Lshared_entities_ChatEntities$UserReference(userReference$2);
      return arg$outer.$$outer$2.getJsContact__Lshared_entities_ChatEntities$UserReference__s_concurrent_Future(userReference)
    })
  })(this);
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  ...
  var this$6 = jsx$3.sequence__sc_TraversableOnce__scg_CanBuildFrom__s_concurrent_ExecutionContext__s_concurrent_Future(jsx$1, this$5.ReusableCBFInstance$2, $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor());
  var f$1 = new $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2().init___LCommunicatorAdapter$$anonfun$getJsDialog$1(this);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  return $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$6, f$1, executor)
});
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype.init___LCommunicatorAdapter__Lshared_entities_ChatEntities$DialogReference = (function($$outer, reference$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.reference$1$f = reference$1;
  return this
});
var $d_LCommunicatorAdapter$$anonfun$getJsDialog$1 = new $TypeData().initClass({
  LCommunicatorAdapter$$anonfun$getJsDialog$1: 0
}, false, "CommunicatorAdapter$$anonfun$getJsDialog$1", {
  LCommunicatorAdapter$$anonfun$getJsDialog$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1.prototype.$classData = $d_LCommunicatorAdapter$$anonfun$getJsDialog$1;
/** @constructor */
function $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype = new $h_sr_AbstractFunction1();
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype.constructor = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2;
/** @constructor */
function $h_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2() {
  /*<skip>*/
}
$h_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype;
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype.apply__sci_List__s_concurrent_Future = (function(usersList) {
  var this$1 = this.$$outer$2.$$outer$2.getMessages__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future(this.$$outer$2.reference$1$f);
  var f = new $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3().init___LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2__sci_List(this, usersList);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
...
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype.apply__O__O = (function(v1) {
  return this.apply__sci_List__s_concurrent_Future($as_sci_List(v1))
});
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype.init___LCommunicatorAdapter$$anonfun$getJsDialog$1 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2 = new $TypeData().initClass({
  LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2: 0
}, false, "CommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2", {
  LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2.prototype.$classData = $d_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2;
/** @constructor */
function $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.usersList$1$2 = null
}
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype = new $h_sr_AbstractFunction1();
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype.constructor = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3;
/** @constructor */
function $h_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3() {
  /*<skip>*/
}
$h_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype = $c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype;
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$Messages__Lshared_entities_FacadeTypes$JsDialogInfo($as_Lshared_entities_ChatEntities$Messages(v1))
});
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype.init___LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2__sci_List = (function($$outer, usersList$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.usersList$1$2 = usersList$1;
  return this
});
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype.apply__Lshared_entities_ChatEntities$Messages__Lshared_entities_FacadeTypes$JsDialogInfo = (function(messages) {
  var $this = {};
  $this.id = null;
  $this.id = this.$$outer$2.$$outer$2.reference$1$f.id$1;
  var col = this.usersList$1$2;
  if ($is_sjs_js_ArrayOps(col)) {
    var x2 = $as_sjs_js_ArrayOps(col);
    var _users = x2.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray(col)) {
    var x3 = $as_sjs_js_WrappedArray(col);
    var _users = x3.array$6
  } else {
    var result = [];
    var these = col;
    while ((!these.isEmpty__Z())) {
  ...
  var this$5 = messages.value__sci_List();
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_Lshared_entities_ChatEntities$Message(x$1$2);
    return x$1.date$1.value$1
  }));
  var ord = $m_s_math_Ordering$String$();
  var this$6 = $as_sci_List($s_sc_SeqLike$class__sortBy__sc_SeqLike__F1__s_math_Ordering__O(this$5, f, ord)).reverse__sci_List();
  var this$7 = $s_sc_TraversableLike$class__headOption__sc_TraversableLike__s_Option(this$6);
  var _lastMessage = $as_Lshared_entities_ChatEntities$Message((this$7.isEmpty__Z() ? new $c_Lshared_entities_ChatEntities$Message().init___Lshared_entities_ChatEntities$DialogReference__Lshared_entities_ChatEntities$UserFullInfo__T__Lshared_entities_ChatEntities$Date(new $c_Lshared_entities_ChatEntities$DialogReference().init___T(""), new $c_Lshared_entities_ChatEntities$UserFullInfo().init___Lshared_entities_ChatEntities$UserReference__Lshared_entities_ChatEntities$UserInfo__Lshared_entities_ChatEntities$Status(new $c_Lshared_entities_ChatEntities$UserReference().init___T(""), new $c_Lshared_entities_ChatEntities$UserInfo().init___T__T("", ""), $m_Lshared_entities_ChatEntities$Offline$()), "", new $c_Lshared_entities_ChatEntities$Date().init___T("")) : this$7.get__O()));
  var this$2$1 = {};
  this$2$1.dialogReference = null;
  this$2$1.users = null;
  this$2$1.lastMessage = null;
  this$2$1.lastMessageDate = null;
  this$2$1.dialogReference = $this;
  this$2$1.users = _users;
  this$2$1.lastMessage = _lastMessage.value$1;
  this$2$1.lastMessageDate = _lastMessage.date$1.value$1;
  return this$2$1
});
var $d_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3 = new $TypeData().initClass({
  LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3: 0
}, false, "CommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3", {
  LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3.prototype.$classData = $d_LCommunicatorAdapter$$anonfun$getJsDialog$1$$anonfun$apply$2$$anonfun$apply$3;
/** @constructor */
function $c_LTransportService$$anonfun$addUser$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_LTransportService$$anonfun$addUser$2.prototype = new $h_sr_AbstractFunction1();
$c_LTransportService$$anonfun$addUser$2.prototype.constructor = $c_LTransportService$$anonfun$addUser$2;
/** @constructor */
function $h_LTransportService$$anonfun$addUser$2() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$addUser$2.prototype = $c_LTransportService$$anonfun$addUser$2.prototype;
$c_LTransportService$$anonfun$addUser$2.prototype.init___LTransportService = (function($$outer) {
  return this
});
$c_LTransportService$$anonfun$addUser$2.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$UserFullInfo__Lshared_entities_FacadeTypes$JsContactInfo($as_Lshared_entities_ChatEntities$UserFullInfo(v1))
});
$c_LTransportService$$anonfun$addUser$2.prototype.apply__Lshared_entities_ChatEntities$UserFullInfo__Lshared_entities_FacadeTypes$JsContactInfo = (function(info) {
  var $this = {};
  $this.contactReference = null;
  $this.name = null;
  $this.avatar = null;
  ...
  var $this$1 = {};
  $this$1.id = null;
  $this$1.id = $as_Lshared_entities_ChatEntities$UserFullInfo($this.info$2$f).userReference$1.id$1;
  $this.contactReference = $this$1;
  $this.name = info.userInfo$1.name$1;
  $this.avatar = info.userInfo$1.avatarUrl$1;
  return $this
});
var $d_LTransportService$$anonfun$addUser$2 = new $TypeData().initClass({
  LTransportService$$anonfun$addUser$2: 0
}, false, "TransportService$$anonfun$addUser$2", {
  LTransportService$$anonfun$addUser$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LTransportService$$anonfun$addUser$2.prototype.$classData = $d_LTransportService$$anonfun$addUser$2;
/** @constructor */
function $c_LTransportService$$anonfun$getOrCreateDialog$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.users$1$f = null
}
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype = new $h_sr_AbstractFunction1();
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype.constructor = $c_LTransportService$$anonfun$getOrCreateDialog$1;
/** @constructor */
function $h_LTransportService$$anonfun$getOrCreateDialog$1() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$getOrCreateDialog$1.prototype = $c_LTransportService$$anonfun$getOrCreateDialog$1.prototype;
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$DialogReferenceOpt__s_concurrent_Future($as_Lshared_entities_ChatEntities$DialogReferenceOpt(v1))
});
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype.init___LTransportService__Lshared_entities_ChatEntities$Users = (function($$outer, users$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.users$1$f = users$1;
  return this
});
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype.apply__Lshared_entities_ChatEntities$DialogReferenceOpt__s_concurrent_Future = (function(optRef) {
  var this$1 = optRef.ref__s_Option();
  if (this$1.isEmpty__Z()) {
    var this$3 = this.$$outer$2.adapter$1;
    var this$2 = new $c_Lshared_entities_ChatEntities$AddDialog().init___Lshared_entities_ChatEntities$Users(this.users$1$f);
    var value = $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this$2);
    var this$5 = this$3.communicator$1;
    var as = new $c_Lshared_utils_TextTransportSerializers$$anon$1().init___();
    var this$7 = this$5.ask__O__Lshared_utils_TransportSerializer__s_concurrent_Future(value, as);
    var ec = $m_s_concurrent_Future$InternalCallbackExecutor$();
    var boxedClass = ($d_Lshared_entities_ChatEntities$DialogReference.getClassOf().isPrimitive__Z() ? $as_jl_Class($m_s_concurrent_Future$().toBoxed$1.apply__O__O($d_Lshared_entities_ChatEntities$DialogReference.getClassOf())) : $d_Lshared_entities_ChatEntities$DialogReference.getClassOf());
    $m_s_Predef$().require__Z__V((boxedClass !== null));
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$this, boxedClass$1) {
      return (function(s$2) {
        if (((boxedClass$1 === $d_sr_Nothing$.getClassOf()) || (((s$2 !== null) && (!boxedClass$1.java$lang$Class$$isRawJSType__Z())) && (!boxedClass$1.isInstance__O__Z(s$2))))) {
    ...
    var this$10 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$7, f, ec);
    var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(ref$2) {
      var ref = $as_Lshared_entities_ChatEntities$DialogReference(ref$2);
      return ref
    }));
    var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
    return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$10, f$1, executor)
  } else {
    var v1 = this$1.get__O();
    var x = $as_Lshared_entities_ChatEntities$DialogReference(v1);
    $m_s_concurrent_Future$();
    var body = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(x$4) {
      return (function() {
        return x$4
      })
    })(x));
...
var $d_LTransportService$$anonfun$getOrCreateDialog$1 = new $TypeData().initClass({
  LTransportService$$anonfun$getOrCreateDialog$1: 0
}, false, "TransportService$$anonfun$getOrCreateDialog$1", {
  LTransportService$$anonfun$getOrCreateDialog$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LTransportService$$anonfun$getOrCreateDialog$1.prototype.$classData = $d_LTransportService$$anonfun$getOrCreateDialog$1;
/** @constructor */
function $c_LTransportService$$anonfun$listContacts$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_LTransportService$$anonfun$listContacts$1.prototype = new $h_sr_AbstractFunction1();
$c_LTransportService$$anonfun$listContacts$1.prototype.constructor = $c_LTransportService$$anonfun$listContacts$1;
/** @constructor */
function $h_LTransportService$$anonfun$listContacts$1() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$listContacts$1.prototype = $c_LTransportService$$anonfun$listContacts$1.prototype;
$c_LTransportService$$anonfun$listContacts$1.prototype.init___LTransportService = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_LTransportService$$anonfun$listContacts$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$Users__s_concurrent_Future($as_Lshared_entities_ChatEntities$Users(v1))
});
$c_LTransportService$$anonfun$listContacts$1.prototype.apply__Lshared_entities_ChatEntities$Users__s_concurrent_Future = (function(userReferences) {
  var jsx$3 = $m_s_concurrent_Future$();
  var this$2 = userReferences.value$1;
  var f = (function(arg$outer) {
    return (function(userReference$2) {
      var userReference = $as_Lshared_entities_ChatEntities$UserReference(userReference$2);
      return arg$outer.$$outer$2.adapter$1.getJsContact__Lshared_entities_ChatEntities$UserReference__s_concurrent_Future(userReference)
    })
  })(this);
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  ...
  var jsx$1 = $as_sc_TraversableOnce(jsx$2);
  var this$5 = $m_sci_List$();
  return jsx$3.sequence__sc_TraversableOnce__scg_CanBuildFrom__s_concurrent_ExecutionContext__s_concurrent_Future(jsx$1, this$5.ReusableCBFInstance$2, $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor())
});
var $d_LTransportService$$anonfun$listContacts$1 = new $TypeData().initClass({
  LTransportService$$anonfun$listContacts$1: 0
}, false, "TransportService$$anonfun$listContacts$1", {
  LTransportService$$anonfun$listContacts$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LTransportService$$anonfun$listContacts$1.prototype.$classData = $d_LTransportService$$anonfun$listContacts$1;
/** @constructor */
function $c_LTransportService$$anonfun$listDialogs$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_LTransportService$$anonfun$listDialogs$1.prototype = new $h_sr_AbstractFunction1();
$c_LTransportService$$anonfun$listDialogs$1.prototype.constructor = $c_LTransportService$$anonfun$listDialogs$1;
/** @constructor */
function $h_LTransportService$$anonfun$listDialogs$1() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$listDialogs$1.prototype = $c_LTransportService$$anonfun$listDialogs$1.prototype;
$c_LTransportService$$anonfun$listDialogs$1.prototype.init___LTransportService = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_LTransportService$$anonfun$listDialogs$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$Dialogs__s_concurrent_Future($as_Lshared_entities_ChatEntities$Dialogs(v1))
});
$c_LTransportService$$anonfun$listDialogs$1.prototype.apply__Lshared_entities_ChatEntities$Dialogs__s_concurrent_Future = (function(dialogReferences) {
  var jsx$3 = $m_s_concurrent_Future$();
  var this$2 = dialogReferences.value__sci_List();
  var f = (function(arg$outer) {
    return (function(reference$2) {
      var reference = $as_Lshared_entities_ChatEntities$DialogReference(reference$2);
      return arg$outer.$$outer$2.adapter$1.getJsDialog__Lshared_entities_ChatEntities$DialogReference__s_concurrent_Future(reference)
    })
  })(this);
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
...
var $d_LTransportService$$anonfun$listDialogs$1 = new $TypeData().initClass({
  LTransportService$$anonfun$listDialogs$1: 0
}, false, "TransportService$$anonfun$listDialogs$1", {
  LTransportService$$anonfun$listDialogs$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LTransportService$$anonfun$listDialogs$1.prototype.$classData = $d_LTransportService$$anonfun$listDialogs$1;
/** @constructor */
function $c_LTransportService$$anonfun$listMessages$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_LTransportService$$anonfun$listMessages$1.prototype = new $h_sr_AbstractFunction1();
$c_LTransportService$$anonfun$listMessages$1.prototype.constructor = $c_LTransportService$$anonfun$listMessages$1;
/** @constructor */
function $h_LTransportService$$anonfun$listMessages$1() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$listMessages$1.prototype = $c_LTransportService$$anonfun$listMessages$1.prototype;
$c_LTransportService$$anonfun$listMessages$1.prototype.init___LTransportService = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_LTransportService$$anonfun$listMessages$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lshared_entities_ChatEntities$Messages__sjs_js_Array($as_Lshared_entities_ChatEntities$Messages(v1))
});
$c_LTransportService$$anonfun$listMessages$1.prototype.apply__Lshared_entities_ChatEntities$Messages__sjs_js_Array = (function(messages) {
  var this$2 = messages.value__sci_List();
  var f = (function(arg$outer) {
    return (function(message$2) {
      var message = $as_Lshared_entities_ChatEntities$Message(message$2);
      return arg$outer.$$outer$2.adapter$1.getJsMessage__Lshared_entities_ChatEntities$Message__Lshared_entities_FacadeTypes$JsMessage(message)
    })
  })(this);
  var this$1 = $m_sci_List$();
  var bf = this$1.ReusableCBFInstance$2;
  ...
  var col = $as_sc_GenTraversableOnce(jsx$1);
...
var $d_LTransportService$$anonfun$listMessages$1 = new $TypeData().initClass({
  LTransportService$$anonfun$listMessages$1: 0
}, false, "TransportService$$anonfun$listMessages$1", {
  LTransportService$$anonfun$listMessages$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_LTransportService$$anonfun$listMessages$1.prototype.$classData = $d_LTransportService$$anonfun$listMessages$1;
function $is_Lshared_entities_ChatEntities$UserAddingEvent(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserAddingEvent)))
}
function $as_Lshared_entities_ChatEntities$UserAddingEvent(obj) {
  return (($is_Lshared_entities_ChatEntities$UserAddingEvent(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserAddingEvent"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserAddingEvent(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserAddingEvent)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserAddingEvent(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserAddingEvent(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserAddingEvent;", depth))
}
var $d_Lshared_entities_ChatEntities$UserAddingEvent = new $TypeData().initClass({
  Lshared_entities_ChatEntities$UserAddingEvent: 0
}, true, "shared.entities.ChatEntities$UserAddingEvent", {
  Lshared_entities_ChatEntities$UserAddingEvent: 1,
  Lshared_entities_ChatEntities$ChatEvent: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
/** @constructor */
function $c_Lshared_entities_ChatEntities$UserFullInfo() {
  $c_O.call(this);
  this.userReference$1 = null;
  this.userInfo$1 = null;
  this.status$1 = null
}
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.constructor = $c_Lshared_entities_ChatEntities$UserFullInfo;
/** @constructor */
function $h_Lshared_entities_ChatEntities$UserFullInfo() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$UserFullInfo.prototype = $c_Lshared_entities_ChatEntities$UserFullInfo.prototype;
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.productPrefix__T = (function() {
  return "UserFullInfo"
});
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.productArity__I = (function() {
  return 3
});
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.init___Lshared_entities_ChatEntities$UserReference__Lshared_entities_ChatEntities$UserInfo__Lshared_entities_ChatEntities$Status = (function(userReference, userInfo, status) {
  this.userReference$1 = userReference;
  this.userInfo$1 = userInfo;
  this.status$1 = status;
  return this
});
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$UserFullInfo(x$1)) {
    var UserFullInfo$1 = $as_Lshared_entities_ChatEntities$UserFullInfo(x$1);
    var x = this.userReference$1;
    var x$2 = UserFullInfo$1.userReference$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.userInfo$1;
      var x$4 = UserFullInfo$1.userInfo$1;
    ...
    if (jsx$1) {
      ...
      var x$6 = UserFullInfo$1.status$1;
      return (x$5 === x$6)
    } else {
      return false
    }
...
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.userReference$1;
      break
    }
    case 1: {
...
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$UserFullInfo(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserFullInfo)))
}
function $as_Lshared_entities_ChatEntities$UserFullInfo(obj) {
  return (($is_Lshared_entities_ChatEntities$UserFullInfo(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserFullInfo"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserFullInfo(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserFullInfo)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserFullInfo(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserFullInfo(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserFullInfo;", depth))
}
var $d_Lshared_entities_ChatEntities$UserFullInfo = new $TypeData().initClass({
  Lshared_entities_ChatEntities$UserFullInfo: 0
}, false, "shared.entities.ChatEntities$UserFullInfo", {
  Lshared_entities_ChatEntities$UserFullInfo: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$UserFullInfo.prototype.$classData = $d_Lshared_entities_ChatEntities$UserFullInfo;
/** @constructor */
function $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1() {
  $c_sr_AbstractFunction2.call(this);
  this.$$outer$2 = null;
  this.recovery$1$f = null
}
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype = new $h_sr_AbstractFunction2();
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype.constructor = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1;
/** @constructor */
function $h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1() {
  /*<skip>*/
}
$h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype;
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype.init___Lutils_Utils$FutureObjectExtension__F1 = (function($$outer, recovery$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.recovery$1$f = recovery$1;
  return this
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype.apply__sjs_js_Function1__sjs_js_Function1__V = (function(resolve, reject) {
  var this$1 = this.$$outer$2.utils$Utils$FutureObjectExtension$$f$f;
  var pf = new $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1().init___Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1__sjs_js_Function1(this, resolve);
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  ...
  var this$2 = this.$$outer$2.utils$Utils$FutureObjectExtension$$f$f;
  var pf$1 = new $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2().init___Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1__sjs_js_Function1(this, reject);
  var executor$1 = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  $s_s_concurrent_Future$class__onFailure__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V(this$2, pf$1, executor$1)
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype.apply__O__O__O = (function(v1, v2) {
  this.apply__sjs_js_Function1__sjs_js_Function1__V(v1, v2)
});
var $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1 = new $TypeData().initClass({
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1: 0
}, false, "utils.Utils$FutureObjectExtension$$anonfun$toPromise$1", {
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1.prototype.$classData = $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1;
/** @constructor */
function $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype = new $h_sr_AbstractFunction1();
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype.constructor = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1;
/** @constructor */
function $h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1() {
  /*<skip>*/
}
$h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype;
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype.apply__O__O = (function(v1) {
  this.apply__Lutils_mediator_transport_TransportFactory__V($as_Lutils_mediator_transport_TransportFactory(v1))
});
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype.apply__Lutils_mediator_transport_TransportFactory__V = (function(factory) {
  var t = $m_Lutils_mediator_transport_SocketIOTransport$().apply__Lutils_mediator_transport_SocketIOConfig__Lutils_mediator_transport_Transport(factory.c$1$1);
  var f = new $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2().init___Lutils_mediator_CommunicatorOps$$anonfun$connect$1__Lutils_mediator_transport_Transport(this, t);
  var this$1 = t.utils$mediator$transport$Transport$$connectEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$1, f);
  var f$1 = new $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4().init___Lutils_mediator_CommunicatorOps$$anonfun$connect$1(this);
  var this$2 = t.utils$mediator$transport$Transport$$sendStringMessageListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$2, f$1);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(x$2$2) {
      arg$outer.$$outer$2.utils$mediator$CommunicatorOps$$connected$1 = false;
      arg$outer.$$outer$2.utils$mediator$CommunicatorOps$$reconnect__V()
    })
  })(this));
  var this$3 = t.utils$mediator$transport$Transport$$disconnectEventListeners$1;
  $s_Lutils_mediator_Listener$class__onEvent__Lutils_mediator_Listener__F1__V(this$3, f$2);
  $s_Lutils_mediator_transport_Transport$class__connect__Lutils_mediator_transport_Transport__V(t)
});
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype.init___Lutils_mediator_CommunicatorOps = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1 = new $TypeData().initClass({
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1: 0
}, false, "utils.mediator.CommunicatorOps$$anonfun$connect$1", {
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1.prototype.$classData = $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1;
/** @constructor */
function $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.t$1$f = null
}
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype = new $h_sr_AbstractFunction1();
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype.constructor = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2;
/** @constructor */
function $h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2() {
  /*<skip>*/
}
$h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype;
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype.apply__O__O = (function(v1) {
  this.apply__O__V(v1)
});
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype.init___Lutils_mediator_CommunicatorOps$$anonfun$connect$1__Lutils_mediator_transport_Transport = (function($$outer, t$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype.apply__O__V = (function(x$1) {
  this.$$outer$2.$$outer$2.utils$mediator$CommunicatorOps$$connected$1 = true;
  this.$$outer$2.$$outer$2.utils$mediator$CommunicatorOps$$internalSend$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(message$2) {
      var message = $as_T(message$2);
      var this$1 = arg$outer.t$1$f;
      $s_Lutils_mediator_transport_Transport$class__send__Lutils_mediator_transport_Transport__T__V(this$1, message)
    })
  })(this));
  this.$$outer$2.$$outer$2.utils$mediator$CommunicatorOps$$unstashAll__V()
});
var $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2 = new $TypeData().initClass({
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2: 0
}, false, "utils.mediator.CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2", {
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2.prototype.$classData = $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$2;
/** @constructor */
function $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype = new $h_sr_AbstractFunction1();
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype.constructor = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4;
/** @constructor */
function $h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4() {
  /*<skip>*/
}
$h_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype = $c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype;
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype.init___Lutils_mediator_CommunicatorOps$$anonfun$connect$1 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype.apply__O__O = (function(v1) {
  this.apply__T__V($as_T(v1))
});
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype.apply__T__V = (function(m) {
  var this$1 = this.$$outer$2.$$outer$2.utils$mediator$CommunicatorOps$$messageEventListeners$1;
  var these = this$1;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var l = $as_F1(arg1);
...
var $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4 = new $TypeData().initClass({
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4: 0
}, false, "utils.mediator.CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4", {
  Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4.prototype.$classData = $d_Lutils_mediator_CommunicatorOps$$anonfun$connect$1$$anonfun$apply$4;
/** @constructor */
function $c_Lutils_mediator_transport_SocketIOConfig() {
  $c_O.call(this);
  this.socket$1 = null
}
$c_Lutils_mediator_transport_SocketIOConfig.prototype = new $h_O();
$c_Lutils_mediator_transport_SocketIOConfig.prototype.constructor = $c_Lutils_mediator_transport_SocketIOConfig;
/** @constructor */
function $h_Lutils_mediator_transport_SocketIOConfig() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_SocketIOConfig.prototype = $c_Lutils_mediator_transport_SocketIOConfig.prototype;
$c_Lutils_mediator_transport_SocketIOConfig.prototype.productPrefix__T = (function() {
  return "SocketIOConfig"
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.productArity__I = (function() {
  return 1
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lutils_mediator_transport_SocketIOConfig(x$1)) {
    var SocketIOConfig$1 = $as_Lutils_mediator_transport_SocketIOConfig(x$1);
    return $m_sr_BoxesRunTime$().equals__O__O__Z(this.socket$1, SocketIOConfig$1.socket$1)
  } else {
    return false
  }
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.socket$1;
      break
...
$c_Lutils_mediator_transport_SocketIOConfig.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.init___Lshared_entities_FacadeTypes$SocketIO = (function(socket) {
  this.socket$1 = socket;
  return this
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lutils_mediator_transport_SocketIOConfig.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lutils_mediator_transport_SocketIOConfig(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lutils_mediator_transport_SocketIOConfig)))
}
function $as_Lutils_mediator_transport_SocketIOConfig(obj) {
  return (($is_Lutils_mediator_transport_SocketIOConfig(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "utils.mediator.transport.SocketIOConfig"))
}
function $isArrayOf_Lutils_mediator_transport_SocketIOConfig(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lutils_mediator_transport_SocketIOConfig)))
}
function $asArrayOf_Lutils_mediator_transport_SocketIOConfig(obj, depth) {
  return (($isArrayOf_Lutils_mediator_transport_SocketIOConfig(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lutils.mediator.transport.SocketIOConfig;", depth))
}
var $d_Lutils_mediator_transport_SocketIOConfig = new $TypeData().initClass({
  Lutils_mediator_transport_SocketIOConfig: 0
}, false, "utils.mediator.transport.SocketIOConfig", {
  Lutils_mediator_transport_SocketIOConfig: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lutils_mediator_transport_SocketIOConfig.prototype.$classData = $d_Lutils_mediator_transport_SocketIOConfig;
/** @constructor */
function $c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype = new $h_sr_AbstractFunction1();
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype.constructor = $c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1;
/** @constructor */
function $h_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype = $c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype;
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype.apply__O__O = (function(v1) {
  this.apply__Lshared_entities_FacadeTypes$SocketIO__V(v1)
});
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype.apply__Lshared_entities_FacadeTypes$SocketIO__V = (function(socket) {
  socket.on("connect", (function(arg$outer) {
    return (function() {
      var this$1 = arg$outer.$$outer$2;
      $s_Lutils_mediator_transport_Transport$class__internalOnConnect__Lutils_mediator_transport_Transport__O__V(this$1, "Connected")
    })
  })(this));
  socket.on("disconnect", (function(arg$outer$1) {
    return (function() {
      var this$2 = arg$outer$1.$$outer$2;
      $s_Lutils_mediator_transport_Transport$class__internalOnDisconnect__Lutils_mediator_transport_Transport__O__V(this$2, "Disconnected")
    })
  })(this));
  socket.on("error", (function(arg$outer$2) {
    return (function(error$2) {
      var error = $as_T(error$2);
      var this$3 = arg$outer$2.$$outer$2;
      var error$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["ERROR: ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([error]));
      var this$4 = this$3.utils$mediator$transport$Transport$$errorEventListeners$1;
      $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$4, error$1)
    })
  })(this));
  socket.on("message received", (function(arg$outer$3) {
    return (function(message$2) {
      var message = $as_T(message$2);
      var this$5 = arg$outer$3.$$outer$2;
      var this$6 = this$5.utils$mediator$transport$Transport$$receiveMessageEventListeners$1;
      $s_Lutils_mediator_Listener$class__notify__Lutils_mediator_Listener__O__V(this$6, message)
    })
  })(this));
  socket.connect()
});
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype.init___Lutils_mediator_transport_SocketIOTransport = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1 = new $TypeData().initClass({
  Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1: 0
}, false, "utils.mediator.transport.SocketIOTransport$$anonfun$internalConnect$1", {
  Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1.prototype.$classData = $d_Lutils_mediator_transport_SocketIOTransport$$anonfun$internalConnect$1;
/** @constructor */
...
/** @constructor */
function $c_LTransportService$$anonfun$addUser$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_LTransportService$$anonfun$addUser$1.prototype = new $h_sr_AbstractPartialFunction();
$c_LTransportService$$anonfun$addUser$1.prototype.constructor = $c_LTransportService$$anonfun$addUser$1;
/** @constructor */
function $h_LTransportService$$anonfun$addUser$1() {
  /*<skip>*/
}
$h_LTransportService$$anonfun$addUser$1.prototype = $c_LTransportService$$anonfun$addUser$1.prototype;
$c_LTransportService$$anonfun$addUser$1.prototype.init___LTransportService = (function($$outer) {
  return this
});
$c_LTransportService$$anonfun$addUser$1.prototype.isDefinedAt__Lshared_entities_ChatEntities$UserAddingEvent__Z = (function(x1) {
  return ($is_Lshared_entities_ChatEntities$UserAdded(x1) || $is_Lshared_entities_ChatEntities$UserAlreadyExists(x1))
});
$c_LTransportService$$anonfun$addUser$1.prototype.applyOrElse__Lshared_entities_ChatEntities$UserAddingEvent__F1__O = (function(x1, $default) {
  if ($is_Lshared_entities_ChatEntities$UserAdded(x1)) {
    var x2 = $as_Lshared_entities_ChatEntities$UserAdded(x1);
    var info = x2.user__Lshared_entities_ChatEntities$UserFullInfo();
    return info
  } else if ($is_Lshared_entities_ChatEntities$UserAlreadyExists(x1)) {
    var x3 = $as_Lshared_entities_ChatEntities$UserAlreadyExists(x1);
    var info$2 = x3.user__Lshared_entities_ChatEntities$UserFullInfo();
    return info$2
  } else {
    return $default.apply__O__O(x1)
  }
});
$c_LTransportService$$anonfun$addUser$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lshared_entities_ChatEntities$UserAddingEvent__Z($as_Lshared_entities_ChatEntities$UserAddingEvent(x))
});
$c_LTransportService$$anonfun$addUser$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lshared_entities_ChatEntities$UserAddingEvent__F1__O($as_Lshared_entities_ChatEntities$UserAddingEvent(x), $default)
});
var $d_LTransportService$$anonfun$addUser$1 = new $TypeData().initClass({
  LTransportService$$anonfun$addUser$1: 0
}, false, "TransportService$$anonfun$addUser$1", {
  LTransportService$$anonfun$addUser$1: 1,
...
$c_LTransportService$$anonfun$addUser$1.prototype.$classData = $d_LTransportService$$anonfun$addUser$1;
/** @constructor */
...
function $is_Lshared_Common$ResponseMessage(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_Common$ResponseMessage)))
}
function $as_Lshared_Common$ResponseMessage(obj) {
  return (($is_Lshared_Common$ResponseMessage(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.Common$ResponseMessage"))
}
function $isArrayOf_Lshared_Common$ResponseMessage(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_Common$ResponseMessage)))
}
function $asArrayOf_Lshared_Common$ResponseMessage(obj, depth) {
  return (($isArrayOf_Lshared_Common$ResponseMessage(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.Common$ResponseMessage;", depth))
}
/** @constructor */
function $c_Lshared_Common$UID() {
  $c_O.call(this);
  this.value$1 = null
}
$c_Lshared_Common$UID.prototype = new $h_O();
$c_Lshared_Common$UID.prototype.constructor = $c_Lshared_Common$UID;
/** @constructor */
function $h_Lshared_Common$UID() {
  /*<skip>*/
}
$h_Lshared_Common$UID.prototype = $c_Lshared_Common$UID.prototype;
$c_Lshared_Common$UID.prototype.productPrefix__T = (function() {
  return "UID"
});
$c_Lshared_Common$UID.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_Common$UID.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_Common$UID(x$1)) {
    var UID$1 = $as_Lshared_Common$UID(x$1);
    return (this.value$1 === UID$1.value$1)
  } else {
    return false
  }
});
$c_Lshared_Common$UID.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.value$1;
      break
...
$c_Lshared_Common$UID.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_Common$UID.prototype.init___T = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lshared_Common$UID.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_Common$UID.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_Common$UID(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_Common$UID)))
}
function $as_Lshared_Common$UID(obj) {
  return (($is_Lshared_Common$UID(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.Common$UID"))
}
function $isArrayOf_Lshared_Common$UID(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_Common$UID)))
}
function $asArrayOf_Lshared_Common$UID(obj, depth) {
  return (($isArrayOf_Lshared_Common$UID(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.Common$UID;", depth))
}
var $d_Lshared_Common$UID = new $TypeData().initClass({
  Lshared_Common$UID: 0
}, false, "shared.Common$UID", {
  Lshared_Common$UID: 1,
  O: 1,
  Lshared_Common$TransportMessage: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  s_Product: 1,
  s_Equals: 1
});
$c_Lshared_Common$UID.prototype.$classData = $d_Lshared_Common$UID;
/** @constructor */
function $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1() {
  $c_sr_AbstractPartialFunction.call(this);
  this.resolve$1$2 = null
}
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype.constructor = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1;
/** @constructor */
function $h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1() {
  /*<skip>*/
}
$h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype;
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype.init___Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1__sjs_js_Function1 = (function($$outer, resolve$1) {
  this.resolve$1$2 = resolve$1;
  return this
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype.isDefinedAt__O__Z = (function(x1) {
  return true
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype.applyOrElse__O__F1__O = (function(x1, $default) {
  return (0, this.resolve$1$2)(x1)
});
var $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1 = new $TypeData().initClass({
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1: 0
}, false, "utils.Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1", {
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1.prototype.$classData = $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$1;
/** @constructor */
function $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2() {
  $c_sr_AbstractPartialFunction.call(this);
  this.$$outer$2 = null;
  this.reject$1$2 = null
}
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype = new $h_sr_AbstractPartialFunction();
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.constructor = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2;
/** @constructor */
function $h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2() {
  /*<skip>*/
}
$h_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype = $c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype;
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.isDefinedAt__jl_Throwable__Z = (function(x2) {
  return true
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.init___Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1__sjs_js_Function1 = (function($$outer, reject$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.reject$1$2 = reject$1;
  return this
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.applyOrElse__jl_Throwable__F1__O = (function(x2, $default) {
  return (0, this.reject$1$2)(this.$$outer$2.recovery$1$f.apply__O__O(x2))
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__jl_Throwable__Z($as_jl_Throwable(x))
});
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__jl_Throwable__F1__O($as_jl_Throwable(x), $default)
});
var $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2 = new $TypeData().initClass({
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2: 0
}, false, "utils.Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2", {
  Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2.prototype.$classData = $d_Lutils_Utils$FutureObjectExtension$$anonfun$toPromise$1$$anonfun$apply$2;
/** @constructor */
function $c_T2() {
  $c_O.call(this);
  this.$$und1$f = null;
...
/** @constructor */
function $c_Lshared_entities_ChatEntities$Date() {
  $c_O.call(this);
  this.value$1 = null
}
$c_Lshared_entities_ChatEntities$Date.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Date.prototype.constructor = $c_Lshared_entities_ChatEntities$Date;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Date() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Date.prototype = $c_Lshared_entities_ChatEntities$Date.prototype;
$c_Lshared_entities_ChatEntities$Date.prototype.productPrefix__T = (function() {
  return "Date"
});
$c_Lshared_entities_ChatEntities$Date.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$Date.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$Date(x$1)) {
    var Date$1 = $as_Lshared_entities_ChatEntities$Date(x$1);
    return (this.value$1 === Date$1.value$1)
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$Date.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.value$1;
      break
...
$c_Lshared_entities_ChatEntities$Date.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$Date.prototype.init___T = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lshared_entities_ChatEntities$Date.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$Date.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$Date(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Date)))
}
function $as_Lshared_entities_ChatEntities$Date(obj) {
  return (($is_Lshared_entities_ChatEntities$Date(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Date"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Date(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Date)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Date(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Date(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Date;", depth))
}
var $d_Lshared_entities_ChatEntities$Date = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Date: 0
}, false, "shared.entities.ChatEntities$Date", {
  Lshared_entities_ChatEntities$Date: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$Date.prototype.$classData = $d_Lshared_entities_ChatEntities$Date;
function $is_Lshared_entities_ChatEntities$DialogInfo(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$DialogInfo)))
}
function $as_Lshared_entities_ChatEntities$DialogInfo(obj) {
  return (($is_Lshared_entities_ChatEntities$DialogInfo(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$DialogInfo"))
}
function $isArrayOf_Lshared_entities_ChatEntities$DialogInfo(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$DialogInfo)))
}
function $asArrayOf_Lshared_entities_ChatEntities$DialogInfo(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$DialogInfo(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$DialogInfo;", depth))
}
var $d_Lshared_entities_ChatEntities$DialogInfo = new $TypeData().initClass({
  Lshared_entities_ChatEntities$DialogInfo: 0
}, false, "shared.entities.ChatEntities$DialogInfo", {
  Lshared_entities_ChatEntities$DialogInfo: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
/** @constructor */
function $c_Lshared_entities_ChatEntities$DialogReference() {
  $c_O.call(this);
  this.id$1 = null
}
$c_Lshared_entities_ChatEntities$DialogReference.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$DialogReference.prototype.constructor = $c_Lshared_entities_ChatEntities$DialogReference;
/** @constructor */
function $h_Lshared_entities_ChatEntities$DialogReference() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$DialogReference.prototype = $c_Lshared_entities_ChatEntities$DialogReference.prototype;
$c_Lshared_entities_ChatEntities$DialogReference.prototype.productPrefix__T = (function() {
  return "DialogReference"
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$DialogReference(x$1)) {
    var DialogReference$1 = $as_Lshared_entities_ChatEntities$DialogReference(x$1);
    return (this.id$1 === DialogReference$1.id$1)
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.id$1;
      break
...
$c_Lshared_entities_ChatEntities$DialogReference.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.init___T = (function(id) {
  this.id$1 = id;
  return this
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$DialogReference.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$DialogReference(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$DialogReference)))
}
function $as_Lshared_entities_ChatEntities$DialogReference(obj) {
  return (($is_Lshared_entities_ChatEntities$DialogReference(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$DialogReference"))
}
function $isArrayOf_Lshared_entities_ChatEntities$DialogReference(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$DialogReference)))
}
function $asArrayOf_Lshared_entities_ChatEntities$DialogReference(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$DialogReference(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$DialogReference;", depth))
}
var $d_Lshared_entities_ChatEntities$DialogReference = new $TypeData().initClass({
  Lshared_entities_ChatEntities$DialogReference: 0
}, false, "shared.entities.ChatEntities$DialogReference", {
  Lshared_entities_ChatEntities$DialogReference: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$DialogReference.prototype.$classData = $d_Lshared_entities_ChatEntities$DialogReference;
function $is_Lshared_entities_ChatEntities$DialogReferenceOpt(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$DialogReferenceOpt)))
}
function $as_Lshared_entities_ChatEntities$DialogReferenceOpt(obj) {
  return (($is_Lshared_entities_ChatEntities$DialogReferenceOpt(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$DialogReferenceOpt"))
}
function $isArrayOf_Lshared_entities_ChatEntities$DialogReferenceOpt(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$DialogReferenceOpt)))
}
function $asArrayOf_Lshared_entities_ChatEntities$DialogReferenceOpt(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$DialogReferenceOpt(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$DialogReferenceOpt;", depth))
}
var $d_Lshared_entities_ChatEntities$DialogReferenceOpt = new $TypeData().initClass({
  Lshared_entities_ChatEntities$DialogReferenceOpt: 0
}, false, "shared.entities.ChatEntities$DialogReferenceOpt", {
  Lshared_entities_ChatEntities$DialogReferenceOpt: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
function $is_Lshared_entities_ChatEntities$Dialogs(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Dialogs)))
}
function $as_Lshared_entities_ChatEntities$Dialogs(obj) {
  return (($is_Lshared_entities_ChatEntities$Dialogs(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Dialogs"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Dialogs(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Dialogs)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Dialogs(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Dialogs(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Dialogs;", depth))
}
var $d_Lshared_entities_ChatEntities$Dialogs = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Dialogs: 0
}, false, "shared.entities.ChatEntities$Dialogs", {
  Lshared_entities_ChatEntities$Dialogs: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
/** @constructor */
function $c_Lshared_entities_ChatEntities$Message() {
  $c_O.call(this);
  this.dialogReference$1 = null;
  this.userFullInfo$1 = null;
  this.value$1 = null;
  this.date$1 = null
}
$c_Lshared_entities_ChatEntities$Message.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Message.prototype.constructor = $c_Lshared_entities_ChatEntities$Message;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Message() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Message.prototype = $c_Lshared_entities_ChatEntities$Message.prototype;
$c_Lshared_entities_ChatEntities$Message.prototype.productPrefix__T = (function() {
  return "Message"
});
$c_Lshared_entities_ChatEntities$Message.prototype.productArity__I = (function() {
  return 4
});
$c_Lshared_entities_ChatEntities$Message.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$Message(x$1)) {
    var Message$1 = $as_Lshared_entities_ChatEntities$Message(x$1);
    var x = this.dialogReference$1;
    var x$2 = Message$1.dialogReference$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.userFullInfo$1;
      var x$4 = Message$1.userFullInfo$1;
      var jsx$1 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      var jsx$1 = false
    };
    if ((jsx$1 && (this.value$1 === Message$1.value$1))) {
      var x$5 = this.date$1;
      var x$6 = Message$1.date$1;
...
$c_Lshared_entities_ChatEntities$Message.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.dialogReference$1;
      break
    }
    case 1: {
      return this.userFullInfo$1;
      break
    }
    case 2: {
      return this.value$1;
...
$c_Lshared_entities_ChatEntities$Message.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$Message.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$Message.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lshared_entities_ChatEntities$Message.prototype.init___Lshared_entities_ChatEntities$DialogReference__Lshared_entities_ChatEntities$UserFullInfo__T__Lshared_entities_ChatEntities$Date = (function(dialogReference, userFullInfo, value, date) {
  this.dialogReference$1 = dialogReference;
  this.userFullInfo$1 = userFullInfo;
  this.value$1 = value;
  this.date$1 = date;
  return this
});
function $is_Lshared_entities_ChatEntities$Message(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Message)))
}
function $as_Lshared_entities_ChatEntities$Message(obj) {
  return (($is_Lshared_entities_ChatEntities$Message(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Message"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Message(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Message)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Message(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Message(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Message;", depth))
}
var $d_Lshared_entities_ChatEntities$Message = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Message: 0
}, false, "shared.entities.ChatEntities$Message", {
  Lshared_entities_ChatEntities$Message: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$Message.prototype.$classData = $d_Lshared_entities_ChatEntities$Message;
function $is_Lshared_entities_ChatEntities$Messages(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Messages)))
}
function $as_Lshared_entities_ChatEntities$Messages(obj) {
  return (($is_Lshared_entities_ChatEntities$Messages(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Messages"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Messages(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Messages)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Messages(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Messages(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Messages;", depth))
}
var $d_Lshared_entities_ChatEntities$Messages = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Messages: 0
}, false, "shared.entities.ChatEntities$Messages", {
  Lshared_entities_ChatEntities$Messages: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
/** @constructor */
function $c_Lshared_entities_ChatEntities$UserInfo() {
  $c_O.call(this);
  this.name$1 = null;
  this.avatarUrl$1 = null
}
$c_Lshared_entities_ChatEntities$UserInfo.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$UserInfo.prototype.constructor = $c_Lshared_entities_ChatEntities$UserInfo;
/** @constructor */
function $h_Lshared_entities_ChatEntities$UserInfo() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$UserInfo.prototype = $c_Lshared_entities_ChatEntities$UserInfo.prototype;
$c_Lshared_entities_ChatEntities$UserInfo.prototype.init___T__T = (function(name, avatarUrl) {
  this.name$1 = name;
  this.avatarUrl$1 = avatarUrl;
  return this
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.productPrefix__T = (function() {
  return "UserInfo"
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.productArity__I = (function() {
  return 2
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$UserInfo(x$1)) {
    var UserInfo$1 = $as_Lshared_entities_ChatEntities$UserInfo(x$1);
    return ((this.name$1 === UserInfo$1.name$1) && (this.avatarUrl$1 === UserInfo$1.avatarUrl$1))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.name$1;
      break
...
$c_Lshared_entities_ChatEntities$UserInfo.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$UserInfo.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$UserInfo(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserInfo)))
}
function $as_Lshared_entities_ChatEntities$UserInfo(obj) {
  return (($is_Lshared_entities_ChatEntities$UserInfo(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserInfo"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserInfo(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserInfo)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserInfo(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserInfo(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserInfo;", depth))
}
var $d_Lshared_entities_ChatEntities$UserInfo = new $TypeData().initClass({
  Lshared_entities_ChatEntities$UserInfo: 0
}, false, "shared.entities.ChatEntities$UserInfo", {
  Lshared_entities_ChatEntities$UserInfo: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$UserInfo.prototype.$classData = $d_Lshared_entities_ChatEntities$UserInfo;
/** @constructor */
function $c_Lshared_entities_ChatEntities$UserReference() {
  $c_O.call(this);
  this.id$1 = null
}
$c_Lshared_entities_ChatEntities$UserReference.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$UserReference.prototype.constructor = $c_Lshared_entities_ChatEntities$UserReference;
/** @constructor */
function $h_Lshared_entities_ChatEntities$UserReference() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$UserReference.prototype = $c_Lshared_entities_ChatEntities$UserReference.prototype;
$c_Lshared_entities_ChatEntities$UserReference.prototype.productPrefix__T = (function() {
  return "UserReference"
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$UserReference(x$1)) {
    var UserReference$1 = $as_Lshared_entities_ChatEntities$UserReference(x$1);
    return (this.id$1 === UserReference$1.id$1)
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.id$1;
      break
...
$c_Lshared_entities_ChatEntities$UserReference.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.init___T = (function(id) {
  this.id$1 = id;
  return this
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$UserReference.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$UserReference(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserReference)))
}
function $as_Lshared_entities_ChatEntities$UserReference(obj) {
  return (($is_Lshared_entities_ChatEntities$UserReference(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserReference"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserReference(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserReference)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserReference(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserReference(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserReference;", depth))
}
var $d_Lshared_entities_ChatEntities$UserReference = new $TypeData().initClass({
  Lshared_entities_ChatEntities$UserReference: 0
}, false, "shared.entities.ChatEntities$UserReference", {
  Lshared_entities_ChatEntities$UserReference: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$UserReference.prototype.$classData = $d_Lshared_entities_ChatEntities$UserReference;
/** @constructor */
function $c_Lshared_entities_ChatEntities$Users() {
  $c_O.call(this);
  this.value$1 = null
}
$c_Lshared_entities_ChatEntities$Users.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Users.prototype.constructor = $c_Lshared_entities_ChatEntities$Users;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Users() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Users.prototype = $c_Lshared_entities_ChatEntities$Users.prototype;
$c_Lshared_entities_ChatEntities$Users.prototype.productPrefix__T = (function() {
  return "Users"
});
$c_Lshared_entities_ChatEntities$Users.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$Users.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$Users(x$1)) {
    var Users$1 = $as_Lshared_entities_ChatEntities$Users(x$1);
    var x = this.value$1;
    var x$2 = Users$1.value$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$Users.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.value$1;
      break
...
$c_Lshared_entities_ChatEntities$Users.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$Users.prototype.init___sci_List = (function(value) {
  this.value$1 = value;
  return this
});
$c_Lshared_entities_ChatEntities$Users.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$Users.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$Users(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Users)))
}
function $as_Lshared_entities_ChatEntities$Users(obj) {
  return (($is_Lshared_entities_ChatEntities$Users(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Users"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Users(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Users)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Users(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Users(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Users;", depth))
}
var $d_Lshared_entities_ChatEntities$Users = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Users: 0
}, false, "shared.entities.ChatEntities$Users", {
  Lshared_entities_ChatEntities$Users: 1,
  O: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$Users.prototype.$classData = $d_Lshared_entities_ChatEntities$Users;
/** @constructor */
function $c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.$$outer$3 = null
}
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype.constructor = $c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1;
/** @constructor */
function $h_Lutils_mediator_transport_Transport$$anonfun$reconnect$1() {
  /*<skip>*/
}
$h_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype = $c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype;
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype.apply$mcV$sp__V = (function() {
  var this$1 = this.$$outer$3.utils$mediator$transport$Transport$$currentConfig$1;
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    var this$2 = this.$$outer$3;
    var config = $as_Lutils_mediator_transport_SocketIOConfig(arg1);
    $s_Lutils_mediator_transport_SocketIOTransport$class__internalConnect__Lutils_mediator_transport_SocketIOTransport__Lutils_mediator_transport_SocketIOConfig__V(this$2, config)
  }
});
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype.init___Lutils_mediator_transport_Transport = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
var $d_Lutils_mediator_transport_Transport$$anonfun$reconnect$1 = new $TypeData().initClass({
  Lutils_mediator_transport_Transport$$anonfun$reconnect$1: 0
}, false, "utils.mediator.transport.Transport$$anonfun$reconnect$1", {
  Lutils_mediator_transport_Transport$$anonfun$reconnect$1: 1,
...
$c_Lutils_mediator_transport_Transport$$anonfun$reconnect$1.prototype.$classData = $d_Lutils_mediator_transport_Transport$$anonfun$reconnect$1;
/** @constructor */
...
/** @constructor */
function $c_Lshared_entities_ChatEntities$AddDialog() {
  $c_O.call(this);
  this.users$1 = null
}
$c_Lshared_entities_ChatEntities$AddDialog.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$AddDialog.prototype.constructor = $c_Lshared_entities_ChatEntities$AddDialog;
/** @constructor */
function $h_Lshared_entities_ChatEntities$AddDialog() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$AddDialog.prototype = $c_Lshared_entities_ChatEntities$AddDialog.prototype;
$c_Lshared_entities_ChatEntities$AddDialog.prototype.productPrefix__T = (function() {
  return "AddDialog"
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$AddDialog(x$1)) {
    var AddDialog$1 = $as_Lshared_entities_ChatEntities$AddDialog(x$1);
    var x = this.users$1;
    var x$2 = AddDialog$1.users$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.users$1;
      break
...
$c_Lshared_entities_ChatEntities$AddDialog.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.init___Lshared_entities_ChatEntities$Users = (function(users) {
  this.users$1 = users;
  return this
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$AddDialog.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$AddDialog(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$AddDialog)))
}
function $as_Lshared_entities_ChatEntities$AddDialog(obj) {
  return (($is_Lshared_entities_ChatEntities$AddDialog(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$AddDialog"))
}
function $isArrayOf_Lshared_entities_ChatEntities$AddDialog(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$AddDialog)))
}
function $asArrayOf_Lshared_entities_ChatEntities$AddDialog(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$AddDialog(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$AddDialog;", depth))
}
var $d_Lshared_entities_ChatEntities$AddDialog = new $TypeData().initClass({
  Lshared_entities_ChatEntities$AddDialog: 0
}, false, "shared.entities.ChatEntities$AddDialog", {
  Lshared_entities_ChatEntities$AddDialog: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$AddDialog.prototype.$classData = $d_Lshared_entities_ChatEntities$AddDialog;
/** @constructor */
function $c_Lshared_entities_ChatEntities$AddMessage() {
  $c_O.call(this);
  this.message$1 = null
}
$c_Lshared_entities_ChatEntities$AddMessage.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$AddMessage.prototype.constructor = $c_Lshared_entities_ChatEntities$AddMessage;
/** @constructor */
function $h_Lshared_entities_ChatEntities$AddMessage() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$AddMessage.prototype = $c_Lshared_entities_ChatEntities$AddMessage.prototype;
$c_Lshared_entities_ChatEntities$AddMessage.prototype.productPrefix__T = (function() {
  return "AddMessage"
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$AddMessage(x$1)) {
    var AddMessage$1 = $as_Lshared_entities_ChatEntities$AddMessage(x$1);
    var x = this.message$1;
    var x$2 = AddMessage$1.message$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Lshared_entities_ChatEntities$AddMessage.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.init___Lshared_entities_ChatEntities$Message = (function(message) {
  this.message$1 = message;
  return this
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$AddMessage.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$AddMessage(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$AddMessage)))
}
function $as_Lshared_entities_ChatEntities$AddMessage(obj) {
  return (($is_Lshared_entities_ChatEntities$AddMessage(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$AddMessage"))
}
function $isArrayOf_Lshared_entities_ChatEntities$AddMessage(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$AddMessage)))
}
function $asArrayOf_Lshared_entities_ChatEntities$AddMessage(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$AddMessage(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$AddMessage;", depth))
}
var $d_Lshared_entities_ChatEntities$AddMessage = new $TypeData().initClass({
  Lshared_entities_ChatEntities$AddMessage: 0
}, false, "shared.entities.ChatEntities$AddMessage", {
  Lshared_entities_ChatEntities$AddMessage: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$AddMessage.prototype.$classData = $d_Lshared_entities_ChatEntities$AddMessage;
/** @constructor */
function $c_Lshared_entities_ChatEntities$AddUser() {
  $c_O.call(this);
  this.info$1 = null
}
$c_Lshared_entities_ChatEntities$AddUser.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$AddUser.prototype.constructor = $c_Lshared_entities_ChatEntities$AddUser;
/** @constructor */
function $h_Lshared_entities_ChatEntities$AddUser() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$AddUser.prototype = $c_Lshared_entities_ChatEntities$AddUser.prototype;
$c_Lshared_entities_ChatEntities$AddUser.prototype.productPrefix__T = (function() {
  return "AddUser"
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$AddUser(x$1)) {
    var AddUser$1 = $as_Lshared_entities_ChatEntities$AddUser(x$1);
    var x = this.info$1;
    var x$2 = AddUser$1.info$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.info$1;
      break
...
$c_Lshared_entities_ChatEntities$AddUser.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.init___Lshared_entities_ChatEntities$UserInfo = (function(info) {
  this.info$1 = info;
  return this
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$AddUser.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$AddUser(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$AddUser)))
}
function $as_Lshared_entities_ChatEntities$AddUser(obj) {
  return (($is_Lshared_entities_ChatEntities$AddUser(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$AddUser"))
}
function $isArrayOf_Lshared_entities_ChatEntities$AddUser(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$AddUser)))
}
function $asArrayOf_Lshared_entities_ChatEntities$AddUser(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$AddUser(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$AddUser;", depth))
}
var $d_Lshared_entities_ChatEntities$AddUser = new $TypeData().initClass({
  Lshared_entities_ChatEntities$AddUser: 0
}, false, "shared.entities.ChatEntities$AddUser", {
  Lshared_entities_ChatEntities$AddUser: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$AddUser.prototype.$classData = $d_Lshared_entities_ChatEntities$AddUser;
/** @constructor */
function $c_Lshared_entities_ChatEntities$Connect() {
  $c_O.call(this);
  this.reference$1 = null
}
$c_Lshared_entities_ChatEntities$Connect.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Connect.prototype.constructor = $c_Lshared_entities_ChatEntities$Connect;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Connect() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Connect.prototype = $c_Lshared_entities_ChatEntities$Connect.prototype;
$c_Lshared_entities_ChatEntities$Connect.prototype.productPrefix__T = (function() {
  return "Connect"
});
$c_Lshared_entities_ChatEntities$Connect.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$Connect.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$Connect(x$1)) {
    var Connect$1 = $as_Lshared_entities_ChatEntities$Connect(x$1);
    var x = this.reference$1;
    var x$2 = Connect$1.reference$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$Connect.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_Lshared_entities_ChatEntities$Connect.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$Connect.prototype.init___Lshared_entities_ChatEntities$UserReference = (function(reference) {
  this.reference$1 = reference;
  return this
});
$c_Lshared_entities_ChatEntities$Connect.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$Connect.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$Connect(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$Connect)))
}
function $as_Lshared_entities_ChatEntities$Connect(obj) {
  return (($is_Lshared_entities_ChatEntities$Connect(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$Connect"))
}
function $isArrayOf_Lshared_entities_ChatEntities$Connect(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$Connect)))
}
function $asArrayOf_Lshared_entities_ChatEntities$Connect(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$Connect(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$Connect;", depth))
}
var $d_Lshared_entities_ChatEntities$Connect = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Connect: 0
}, false, "shared.entities.ChatEntities$Connect", {
  Lshared_entities_ChatEntities$Connect: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$Connect.prototype.$classData = $d_Lshared_entities_ChatEntities$Connect;
/** @constructor */
function $c_Lshared_entities_ChatEntities$GetDialog() {
  $c_O.call(this);
  this.users$1 = null
}
$c_Lshared_entities_ChatEntities$GetDialog.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$GetDialog.prototype.constructor = $c_Lshared_entities_ChatEntities$GetDialog;
/** @constructor */
function $h_Lshared_entities_ChatEntities$GetDialog() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$GetDialog.prototype = $c_Lshared_entities_ChatEntities$GetDialog.prototype;
$c_Lshared_entities_ChatEntities$GetDialog.prototype.productPrefix__T = (function() {
  return "GetDialog"
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$GetDialog(x$1)) {
    var GetDialog$1 = $as_Lshared_entities_ChatEntities$GetDialog(x$1);
    var x = this.users$1;
    var x$2 = GetDialog$1.users$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.users$1;
      break
...
$c_Lshared_entities_ChatEntities$GetDialog.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.init___Lshared_entities_ChatEntities$Users = (function(users) {
  this.users$1 = users;
  return this
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$GetDialog.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$GetDialog(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$GetDialog)))
}
function $as_Lshared_entities_ChatEntities$GetDialog(obj) {
  return (($is_Lshared_entities_ChatEntities$GetDialog(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$GetDialog"))
}
function $isArrayOf_Lshared_entities_ChatEntities$GetDialog(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$GetDialog)))
}
function $asArrayOf_Lshared_entities_ChatEntities$GetDialog(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$GetDialog(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$GetDialog;", depth))
}
var $d_Lshared_entities_ChatEntities$GetDialog = new $TypeData().initClass({
  Lshared_entities_ChatEntities$GetDialog: 0
}, false, "shared.entities.ChatEntities$GetDialog", {
  Lshared_entities_ChatEntities$GetDialog: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$GetDialog.prototype.$classData = $d_Lshared_entities_ChatEntities$GetDialog;
/** @constructor */
function $c_Lshared_entities_ChatEntities$ListDialogs() {
  $c_O.call(this);
  this.reference$1 = null
}
$c_Lshared_entities_ChatEntities$ListDialogs.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.constructor = $c_Lshared_entities_ChatEntities$ListDialogs;
/** @constructor */
function $h_Lshared_entities_ChatEntities$ListDialogs() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$ListDialogs.prototype = $c_Lshared_entities_ChatEntities$ListDialogs.prototype;
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.productPrefix__T = (function() {
  return "ListDialogs"
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.productArity__I = (function() {
  return 1
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lshared_entities_ChatEntities$ListDialogs(x$1)) {
    var ListDialogs$1 = $as_Lshared_entities_ChatEntities$ListDialogs(x$1);
    var x = this.reference$1;
    var x$2 = ListDialogs$1.reference$1;
    return ((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))
  } else {
    return false
  }
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.reference$1;
      break
...
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.init___Lshared_entities_ChatEntities$UserReference = (function(reference) {
  this.reference$1 = reference;
  return this
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$ListDialogs(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$ListDialogs)))
}
function $as_Lshared_entities_ChatEntities$ListDialogs(obj) {
  return (($is_Lshared_entities_ChatEntities$ListDialogs(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$ListDialogs"))
}
function $isArrayOf_Lshared_entities_ChatEntities$ListDialogs(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$ListDialogs)))
}
function $asArrayOf_Lshared_entities_ChatEntities$ListDialogs(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$ListDialogs(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$ListDialogs;", depth))
}
var $d_Lshared_entities_ChatEntities$ListDialogs = new $TypeData().initClass({
  Lshared_entities_ChatEntities$ListDialogs: 0
}, false, "shared.entities.ChatEntities$ListDialogs", {
  Lshared_entities_ChatEntities$ListDialogs: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$ListDialogs.prototype.$classData = $d_Lshared_entities_ChatEntities$ListDialogs;
/** @constructor */
function $c_Lshared_entities_ChatEntities$ListUsers() {
  $c_O.call(this)
}
$c_Lshared_entities_ChatEntities$ListUsers.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$ListUsers.prototype.constructor = $c_Lshared_entities_ChatEntities$ListUsers;
/** @constructor */
function $h_Lshared_entities_ChatEntities$ListUsers() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$ListUsers.prototype = $c_Lshared_entities_ChatEntities$ListUsers.prototype;
$c_Lshared_entities_ChatEntities$ListUsers.prototype.init___ = (function() {
  return this
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.productPrefix__T = (function() {
  return "ListUsers"
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.productArity__I = (function() {
  return 0
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.equals__O__Z = (function(x$1) {
  return ($is_Lshared_entities_ChatEntities$ListUsers(x$1) && ($as_Lshared_entities_ChatEntities$ListUsers(x$1), true))
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lshared_entities_ChatEntities$ListUsers.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lshared_entities_ChatEntities$ListUsers(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$ListUsers)))
}
function $as_Lshared_entities_ChatEntities$ListUsers(obj) {
  return (($is_Lshared_entities_ChatEntities$ListUsers(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$ListUsers"))
}
function $isArrayOf_Lshared_entities_ChatEntities$ListUsers(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$ListUsers)))
}
function $asArrayOf_Lshared_entities_ChatEntities$ListUsers(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$ListUsers(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$ListUsers;", depth))
}
var $d_Lshared_entities_ChatEntities$ListUsers = new $TypeData().initClass({
  Lshared_entities_ChatEntities$ListUsers: 0
}, false, "shared.entities.ChatEntities$ListUsers", {
  Lshared_entities_ChatEntities$ListUsers: 1,
  O: 1,
  Lshared_entities_ChatEntities$ChatCommand: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$ListUsers.prototype.$classData = $d_Lshared_entities_ChatEntities$ListUsers;
/** @constructor */
function $c_Lshared_entities_ChatEntities$Offline$() {
  $c_O.call(this)
}
$c_Lshared_entities_ChatEntities$Offline$.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Offline$.prototype.constructor = $c_Lshared_entities_ChatEntities$Offline$;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Offline$() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Offline$.prototype = $c_Lshared_entities_ChatEntities$Offline$.prototype;
$c_Lshared_entities_ChatEntities$Offline$.prototype.init___ = (function() {
  return this
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.productPrefix__T = (function() {
  return "Offline"
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.productArity__I = (function() {
  return 0
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.toString__T = (function() {
  return "Offline"
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.hashCode__I = (function() {
  return 116041155
});
$c_Lshared_entities_ChatEntities$Offline$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lshared_entities_ChatEntities$Offline$ = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Offline$: 0
}, false, "shared.entities.ChatEntities$Offline$", {
  Lshared_entities_ChatEntities$Offline$: 1,
  O: 1,
  Lshared_entities_ChatEntities$Status: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
...
$c_Lshared_entities_ChatEntities$Offline$.prototype.$classData = $d_Lshared_entities_ChatEntities$Offline$;
var $n_Lshared_entities_ChatEntities$Offline$ = (void 0);
function $m_Lshared_entities_ChatEntities$Offline$() {
  if ((!$n_Lshared_entities_ChatEntities$Offline$)) {
    $n_Lshared_entities_ChatEntities$Offline$ = new $c_Lshared_entities_ChatEntities$Offline$().init___()
  };
  return $n_Lshared_entities_ChatEntities$Offline$
}
/** @constructor */
function $c_Lshared_entities_ChatEntities$Online$() {
  $c_O.call(this)
}
$c_Lshared_entities_ChatEntities$Online$.prototype = new $h_O();
$c_Lshared_entities_ChatEntities$Online$.prototype.constructor = $c_Lshared_entities_ChatEntities$Online$;
/** @constructor */
function $h_Lshared_entities_ChatEntities$Online$() {
  /*<skip>*/
}
$h_Lshared_entities_ChatEntities$Online$.prototype = $c_Lshared_entities_ChatEntities$Online$.prototype;
$c_Lshared_entities_ChatEntities$Online$.prototype.init___ = (function() {
  return this
});
$c_Lshared_entities_ChatEntities$Online$.prototype.productPrefix__T = (function() {
  return "Online"
});
$c_Lshared_entities_ChatEntities$Online$.prototype.productArity__I = (function() {
  return 0
});
$c_Lshared_entities_ChatEntities$Online$.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lshared_entities_ChatEntities$Online$.prototype.toString__T = (function() {
  return "Online"
});
$c_Lshared_entities_ChatEntities$Online$.prototype.hashCode__I = (function() {
  return (-1928355213)
});
$c_Lshared_entities_ChatEntities$Online$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $d_Lshared_entities_ChatEntities$Online$ = new $TypeData().initClass({
  Lshared_entities_ChatEntities$Online$: 0
}, false, "shared.entities.ChatEntities$Online$", {
  Lshared_entities_ChatEntities$Online$: 1,
  O: 1,
  Lshared_entities_ChatEntities$Status: 1,
  Lshared_entities_ChatEntities$Entity: 1,
  Lshared_entities_ChatEntities$CirceSerializable: 1,
...
$c_Lshared_entities_ChatEntities$Online$.prototype.$classData = $d_Lshared_entities_ChatEntities$Online$;
var $n_Lshared_entities_ChatEntities$Online$ = (void 0);
function $m_Lshared_entities_ChatEntities$Online$() {
  if ((!$n_Lshared_entities_ChatEntities$Online$)) {
    $n_Lshared_entities_ChatEntities$Online$ = new $c_Lshared_entities_ChatEntities$Online$().init___()
  };
  return $n_Lshared_entities_ChatEntities$Online$
}
/** @constructor */
...
function $is_Lshared_entities_ChatEntities$UserAdded(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserAdded)))
}
function $as_Lshared_entities_ChatEntities$UserAdded(obj) {
  return (($is_Lshared_entities_ChatEntities$UserAdded(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserAdded"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserAdded(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserAdded)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserAdded(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserAdded(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserAdded;", depth))
}
function $is_Lshared_entities_ChatEntities$UserAlreadyExists(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lshared_entities_ChatEntities$UserAlreadyExists)))
}
function $as_Lshared_entities_ChatEntities$UserAlreadyExists(obj) {
  return (($is_Lshared_entities_ChatEntities$UserAlreadyExists(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "shared.entities.ChatEntities$UserAlreadyExists"))
}
function $isArrayOf_Lshared_entities_ChatEntities$UserAlreadyExists(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lshared_entities_ChatEntities$UserAlreadyExists)))
}
function $asArrayOf_Lshared_entities_ChatEntities$UserAlreadyExists(obj, depth) {
  return (($isArrayOf_Lshared_entities_ChatEntities$UserAlreadyExists(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lshared.entities.ChatEntities$UserAlreadyExists;", depth))
}
/** @constructor */
...
$c_sci_Queue.prototype.apply__I__O = (function(n) {
  var this$1 = this.out$4;
  var olen = $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(this$1);
  if ((n < olen)) {
    ...
    var m = ((n - olen) | 0);
    var this$3 = this.in$4;
    var ilen = $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(this$3);
    if ((m < ilen)) {
      var this$4 = this.in$4;
      var n$1 = (((-1) + ((ilen - m) | 0)) | 0);
      return $s_sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$4, n$1)
    } else {
...
$c_sci_Queue.prototype.$$plus$colon__O__scg_CanBuildFrom__O = (function(elem, bf) {
  if ($is_scg_GenTraversableFactory$GenericCanBuildFrom(bf)) {
    var jsx$1 = this.in$4;
    var this$1 = this.out$4;
    return new $c_sci_Queue().init___sci_List__sci_List(jsx$1, new $c_sci_$colon$colon().init___O__sci_List(elem, this$1))
  } else {
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
/** @constructor */
$e.TransportService = (function(arg$1) {
  var $thiz = new $c_LTransportService();
  var prep0 = arg$1;
  $c_LTransportService.prototype.init___Lshared_entities_FacadeTypes$SocketIO.call($thiz, prep0);
  return $thiz
});
$e.TransportService.prototype = $c_LTransportService.prototype;
